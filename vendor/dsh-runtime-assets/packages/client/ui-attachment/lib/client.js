window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/Users/chenrongjian/WorkBuddy/DeepSeek/deepseek-harness/packages/client/ui-attachment/src/AttachmentRail.module.css.mjs
		const css$4 = ".QPwr6q_root{min-width:0;position:relative}.QPwr6q_rail{scrollbar-width:none;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);gap:10px;display:flex;overflow:auto hidden}.QPwr6q_rail::-webkit-scrollbar{display:none}.QPwr6q_item{flex:0 0 64px;width:64px;height:64px;position:relative}.QPwr6q_thumbnail{border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-alias-interactive-bg-hover);cursor:zoom-in;border-radius:16px;width:64px;height:64px;padding:0;overflow:hidden}.QPwr6q_thumbnail img{object-fit:cover;width:100%;height:100%;display:block}.QPwr6q_remove{z-index:1;background:var(--dsw-alias-button-contrast-fill);width:18px;height:18px;color:var(--dsw-alias-label-primary-inverted);cursor:pointer;opacity:0;border:none;border-radius:50%;place-items:center;padding:0;transition:opacity .2s ease-in-out;display:grid;position:absolute;top:4px;right:4px}.QPwr6q_item:hover .QPwr6q_remove,.QPwr6q_remove:focus-visible{opacity:1}@media (pointer:coarse){.QPwr6q_remove{opacity:1}}@media (prefers-reduced-motion:reduce){.QPwr6q_remove{transition:none}}.QPwr6q_arrow{z-index:2;border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-specific-input-major);width:24px;height:24px;color:var(--dsw-alias-label-secondary);box-shadow:var(--dsw-shadow-lv2);cursor:pointer;border-radius:999px;place-items:center;padding:0;display:grid;position:absolute;top:50%;transform:translateY(-50%)}.QPwr6q_arrow:hover{background:var(--dsw-alias-interactive-bg-hover-solid)}.QPwr6q_arrowLeft{left:4px}.QPwr6q_arrowRight{right:4px}";
		...
		var AttachmentRail_module_css_default = {
			"arrow": "QPwr6q_arrow",
			"arrowLeft": "QPwr6q_arrowLeft",
			"arrowRight": "QPwr6q_arrowRight",
			"item": "QPwr6q_item",
			"rail": "QPwr6q_rail",
			"remove": "QPwr6q_remove",
			"root": "QPwr6q_root",
			"thumbnail": "QPwr6q_thumbnail"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chenrongjian/WorkBuddy/DeepSeek/deepseek-harness/packages/client/ui-attachment/src/DropOverlay.module.css.mjs
		const css$3 = "._4f4Fea_mask{z-index:1000;pointer-events:none;background-color:var(--dsw-alias-bg-mask-drop);backdrop-filter:blur(10px);justify-content:center;align-items:center;animation:.16s ease-out _4f4Fea_fade-in;display:flex;position:fixed;inset:0}@keyframes _4f4Fea_fade-in{0%{opacity:0}to{opacity:1}}@media (prefers-reduced-motion:reduce){._4f4Fea_mask{animation:none}}._4f4Fea_wrap{color:var(--dsw-alias-label-primary);text-align:center;flex-direction:column;align-items:center;margin-top:-3%;padding:0 40px;display:flex}._4f4Fea_illustration{width:115px;height:84px}._4f4Fea_title{font:var(--dsw-font-l-20);margin-top:16px}._4f4Fea_desc{font:var(--dsw-font-s-14);color:var(--dsw-alias-label-tertiary);white-space:pre-wrap;margin-top:16px}";
		...
		var DropOverlay_module_css_default = {
			"desc": "_4f4Fea_desc",
			"fade-in": "_4f4Fea_fade-in",
			"illustration": "_4f4Fea_illustration",
			"mask": "_4f4Fea_mask",
			"title": "_4f4Fea_title",
			"wrap": "_4f4Fea_wrap"
		};
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chenrongjian/WorkBuddy/DeepSeek/deepseek-harness/packages/client/ui-attachment/src/ImageLightbox.module.css.mjs
		const css$2 = ".fMvqSq_backdrop{z-index:1000;place-items:center;padding:40px;display:grid;position:fixed;inset:0}.fMvqSq_mask{background:var(--dsw-alias-bg-mask-1);backdrop-filter:var(--dsw-mask-blur);position:absolute;inset:0}.fMvqSq_image{object-fit:contain;background:var(--dsw-specific-input-major);max-width:min(100%,1600px);max-height:calc(100vh - 80px);box-shadow:var(--dsw-shadow-lv3);border-radius:12px;position:relative}.fMvqSq_close{z-index:1;border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-specific-input-major);width:36px;height:36px;color:var(--dsw-alias-label-primary);cursor:pointer;border-radius:999px;place-items:center;display:grid;position:fixed;top:20px;right:20px}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chenrongjian/WorkBuddy/DeepSeek/deepseek-harness/packages/client/ui-attachment/src/client/ComposerAttachments.module.css.mjs
		const css$1 = ".pDKwPq_rail{min-width:0;padding:4px 12px 0}";
		...
		var ComposerAttachments_module_css_default = { "rail": "pDKwPq_rail" };
		//#endregion
		...
		//#endregion
		//#region \0dsh-css:/Users/chenrongjian/WorkBuddy/DeepSeek/deepseek-harness/packages/client/ui-attachment/src/MessageImage.module.css.mjs
		const css = "._3v2u_q_gallery{flex-wrap:wrap;gap:10px;max-width:100%;display:flex}._3v2u_q_gallery[data-align=end]{justify-content:flex-end;align-self:flex-end}._3v2u_q_gallery[data-align=start]{justify-content:flex-start;align-self:flex-start}._3v2u_q_frame{border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-alias-interactive-bg-hover);cursor:zoom-in;border-radius:16px;flex:none;place-items:center;min-width:44px;min-height:44px;padding:0;display:grid;overflow:hidden}._3v2u_q_frame[data-variant=tile]{width:64px;min-width:64px;height:64px;min-height:64px}._3v2u_q_frame img{object-fit:cover;width:100%;height:100%;display:block}._3v2u_q_loading,._3v2u_q_error{color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:18px}._3v2u_q_error{border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-alias-interactive-bg-hover-danger);cursor:pointer;border-radius:10px;max-width:240px;padding:10px 12px}._3v2u_q_error[data-variant=tile]{border-radius:16px;width:64px;height:64px;padding:4px;overflow:hidden}";
		...
		var MessageImage_module_css_default = {
			"error": "_3v2u_q_error",
			"frame": "_3v2u_q_frame",
			"gallery": "_3v2u_q_gallery",
			"loading": "_3v2u_q_loading"
		};
		//#endregion
