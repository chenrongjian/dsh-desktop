window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/Users/chenrongjian/WorkBuddy/DeepSeek/deepseek-harness/packages/client/ui-settings-plugins/src/client/fields.module.css.mjs
		const css$2 = ".Y045mG_field{flex-direction:column;gap:6px;padding:12px 0;display:flex}.Y045mG_field+.Y045mG_field{border-top:1px solid var(--dsw-alias-border-l2)}.Y045mG_head{align-items:center;gap:8px;display:flex}.Y045mG_label{min-width:0;color:var(--dsw-alias-label-primary);flex:1;font-size:13px;font-weight:500;line-height:1.5}.Y045mG_badges{align-items:center;gap:8px;display:inline-flex}.Y045mG_badge{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.Y045mG_badgeMuted{white-space:nowrap;color:var(--dsw-alias-label-tertiary);border-radius:999px;padding:1px 8px;font-size:11px;line-height:17px}.Y045mG_reset{font:inherit;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;padding:0;font-size:12px;line-height:1.5}.Y045mG_reset:hover:not(:disabled){color:var(--dsw-alias-label-primary)}.Y045mG_reset:disabled{cursor:default}.Y045mG_input{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);height:34px;font:inherit;color:var(--dsw-alias-label-primary);border-radius:8px;padding:0 12px;font-size:13px;line-height:1.5}.Y045mG_input:focus-visible{border-color:var(--dsw-alias-brand-primary);outline:none}.Y045mG_input:disabled{color:var(--dsw-alias-label-tertiary);cursor:default}.Y045mG_inputInvalid{border-color:var(--dsw-alias-label-error);}.Y045mG_invalid{color:var(--dsw-alias-label-error);margin:0;font-size:12px;line-height:1.5}.Y045mG_hint{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;line-height:1.5}";
		...
		var fields_module_css_default = {
			"badge": "Y045mG_badge",
			"badgeMuted": "Y045mG_badgeMuted",
			"badges": "Y045mG_badges",
			"field": "Y045mG_field",
			"head": "Y045mG_head",
			"hint": "Y045mG_hint",
			"input": "Y045mG_input",
			"inputInvalid": "Y045mG_inputInvalid",
			"invalid": "Y045mG_invalid",
			"label": "Y045mG_label",
			"reset": "Y045mG_reset"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chenrongjian/WorkBuddy/DeepSeek/deepseek-harness/packages/client/ui-settings-plugins/src/client/PluginCard.module.css.mjs
		const css$1 = ".QccP6W_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;list-style:none;transition:border-color .16s,background .16s}.QccP6W_card:hover{border-color:var(--dsw-alias-label-dimmed)}.QccP6W_cardOpen{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-dimmed)}.QccP6W_header{appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;display:flex}.QccP6W_header:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}.QccP6W_headText{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}.QccP6W_name{color:var(--dsw-alias-label-primary);font-size:15px;font-weight:600;line-height:1.4}.QccP6W_description{color:var(--dsw-alias-label-tertiary);font-size:13px;line-height:1.5}.QccP6W_chevron{color:var(--dsw-alias-label-tertiary);flex:none;transition:transform .16s}.QccP6W_chevronOpen{transform:rotate(180deg)}.QccP6W_body{border-top:1px solid var(--dsw-alias-border-l2);margin:0 16px;padding-bottom:8px}.QccP6W_readOnly{color:var(--dsw-alias-label-tertiary);margin:12px 0 0;font-size:12px;line-height:1.5}.QccP6W_pending{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.QccP6W_footer{border-top:1px solid var(--dsw-alias-border-l2);justify-content:flex-end;align-items:center;gap:8px;padding:12px 0 4px;display:flex}.QccP6W_failed{min-width:0;color:var(--dsw-alias-label-error);flex:1;margin:0;font-size:12px;line-height:1.5}.QccP6W_discard,.QccP6W_save{appearance:none;font:inherit;cursor:pointer;border:1px solid #0000;border-radius:8px;padding:5px 14px;font-size:13px;line-height:1.5}.QccP6W_discard{border-color:var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);background:0 0}.QccP6W_discard:hover:not(:disabled){color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-label-dimmed)}.QccP6W_save{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3)}.QccP6W_discard:disabled,.QccP6W_save:disabled{opacity:.4;cursor:default}.QccP6W_discard:focus-visible,.QccP6W_save:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:1px}";
		...
		var PluginCard_module_css_default = {
			"body": "QccP6W_body",
			"card": "QccP6W_card",
			"cardOpen": "QccP6W_cardOpen",
			"chevron": "QccP6W_chevron",
			"chevronOpen": "QccP6W_chevronOpen",
			"description": "QccP6W_description",
			"discard": "QccP6W_discard",
			"failed": "QccP6W_failed",
			"footer": "QccP6W_footer",
			"headText": "QccP6W_headText",
			"header": "QccP6W_header",
			"name": "QccP6W_name",
			"pending": "QccP6W_pending",
			"readOnly": "QccP6W_readOnly",
			"save": "QccP6W_save"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chenrongjian/WorkBuddy/DeepSeek/deepseek-harness/packages/client/ui-settings-plugins/src/client/PluginsSettingsSection.module.css.mjs
		const css = ".b9yXHW_section{max-width:760px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;display:flex}.b9yXHW_heading{margin:0;font-size:18px;font-weight:600}.b9yXHW_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}.b9yXHW_tabs{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:flex-end;gap:22px;margin-top:2px;display:flex}.b9yXHW_tab{color:var(--dsw-alias-label-tertiary);font:inherit;cursor:pointer;background:0 0;border:0;padding:7px 1px 9px;font-size:13px;line-height:20px;position:relative}.b9yXHW_tab:hover,.b9yXHW_tab[data-active=true]{color:var(--dsw-alias-label-primary)}.b9yXHW_tab[data-active=true]:after,.b9yXHW_tab:focus-visible:after{background:var(--dsw-alias-label-primary);content:\"\";border-radius:2px 2px 0 0;height:2px;position:absolute;bottom:-1px;left:0;right:0}.b9yXHW_tab:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px;color:var(--dsw-alias-label-primary);border-radius:2px}.b9yXHW_panel{min-width:0;padding-top:2px}.b9yXHW_cards{flex-direction:column;gap:10px;margin:0;padding:0;list-style:none;display:flex}.b9yXHW_empty{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}";
		...
		var PluginsSettingsSection_module_css_default = {
			"cards": "b9yXHW_cards",
			"empty": "b9yXHW_empty",
			"heading": "b9yXHW_heading",
			"intro": "b9yXHW_intro",
			"panel": "b9yXHW_panel",
			"section": "b9yXHW_section",
			"tab": "b9yXHW_tab",
			"tabs": "b9yXHW_tabs"
		};
		//#endregion
