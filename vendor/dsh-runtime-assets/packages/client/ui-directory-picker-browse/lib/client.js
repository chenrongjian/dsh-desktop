window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/Users/chenrongjian/WorkBuddy/DeepSeek/deepseek-harness/packages/client/ui-directory-picker-browse/src/client/DirectoryBrowser.module.css.mjs
		const css = ".Z0oESa_dialog.Z0oESa_dialog{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);gap:0;width:min(680px,100%);height:min(500px,100dvh - 32px);padding:0}.Z0oESa_editorScope{display:contents}.Z0oESa_header{border-bottom:1px solid var(--dsw-alias-border-l3);flex-direction:column;flex:none;gap:8px;padding:16px 14px 8px 24px;display:flex}.Z0oESa_title{min-height:28px;color:var(--dsw-alias-label-primary);align-items:flex-end;margin:0;font-size:16px;font-weight:510;line-height:24px;display:flex}.Z0oESa_crumbBar{box-sizing:border-box;border:1px solid #0000;border-radius:8px;align-items:center;gap:4px;min-height:24px;margin-left:-9px;padding:0 8px;display:flex}.Z0oESa_crumbBar:has(.Z0oESa_crumbEditZone:enabled:hover),.Z0oESa_crumbBar:has(.Z0oESa_crumbEditZone:focus-visible),.Z0oESa_crumbBar:has(.Z0oESa_pathInput){border-color:var(--dsw-alias-border-l2)}.Z0oESa_millerRow{scrollbar-width:none;flex:1 1 0;align-items:stretch;gap:12px;min-height:0;display:flex;overflow-x:auto}.Z0oESa_crumbTrail{scrollbar-width:none;flex:0 auto;align-items:center;gap:4px;min-width:0;display:flex;overflow-x:auto}.Z0oESa_crumbSeat{flex:none;align-items:center;gap:4px;min-width:0;display:inline-flex}.Z0oESa_crumb{text-overflow:ellipsis;white-space:nowrap;max-width:160px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;padding:0;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.Z0oESa_crumb:hover{color:var(--dsw-alias-label-primary)}.Z0oESa_crumbChevron{color:var(--dsw-alias-label-tertiary);flex:none}.Z0oESa_crumbEditZone{cursor:text;background:0 0;border:none;outline:none;flex:1 0 34px;justify-content:flex-end;align-items:center;min-width:34px;height:22px;padding:0;display:flex}.Z0oESa_crumbEditGlyph{color:var(--dsw-alias-label-tertiary);flex:none}.Z0oESa_crumbEditZone:enabled:hover .Z0oESa_crumbEditGlyph,.Z0oESa_crumbEditZone:focus-visible .Z0oESa_crumbEditGlyph{color:var(--dsw-alias-label-primary)}.Z0oESa_crumbEditZone:disabled{cursor:default}.Z0oESa_crumbEditZone:disabled .Z0oESa_crumbEditGlyph{color:var(--dsw-alias-label-caption)}.Z0oESa_pathInput{box-sizing:border-box;min-width:0;height:22px;color:var(--dsw-alias-label-primary);background:0 0;border:none;outline:none;flex:1 1 0;padding:0;font-size:13px;line-height:20px}.Z0oESa_content{flex-direction:column;flex:1 1 0;min-height:0;padding:16px 16px 16px 24px;display:flex;position:relative}.Z0oESa_column{flex-direction:column;flex:1 1 0;gap:2px;min-width:256px;padding-right:8px;display:flex;overflow-y:auto}.Z0oESa_divider{background:var(--dsw-alias-border-l3);flex:none;width:1px}.Z0oESa_rowSeat{flex:none;display:flex}.Z0oESa_row{text-align:left;cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;align-items:center;gap:4px;width:100%;height:28px;padding:4px;display:flex}.Z0oESa_row:hover{background:var(--dsw-alias-interactive-bg-hover)}.Z0oESa_rowSelected,.Z0oESa_rowSelected:hover{background:var(--dsw-alias-interactive-bg-active,var(--dsw-alias-interactive-bg-hover))}.Z0oESa_rowIcon{color:var(--dsw-alias-label-secondary);flex:none}.Z0oESa_rowIconSelected{color:var(--dsw-alias-button-info-fill);flex:none}.Z0oESa_rowName{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-primary);flex:1 1 0;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.Z0oESa_rowChevron{color:var(--dsw-alias-label-tertiary);flex:none}.Z0oESa_status,.Z0oESa_error{padding:4px 120px 4px 4px;font-size:12px;line-height:18px}.Z0oESa_status{color:var(--dsw-alias-label-secondary)}.Z0oESa_error{color:var(--dsw-alias-state-error-primary)}.Z0oESa_loadingFloat{background:var(--dsw-alias-bg-layer-2);padding:2px 8px;position:absolute;bottom:8px;right:16px}.Z0oESa_footerBar{border-top:1px solid var(--dsw-alias-border-l3);flex-wrap:wrap;flex:none;align-items:center;gap:8px;padding:16px 24px;display:flex}.Z0oESa_showHiddenToggle{color:var(--dsw-alias-label-secondary);cursor:pointer;white-space:nowrap;background:0 0;border:none;align-items:center;gap:4px;padding:0;font-size:13px;font-weight:500;line-height:20px;display:inline-flex}.Z0oESa_showHiddenToggle:hover{color:var(--dsw-alias-label-primary)}.Z0oESa_showHiddenToggle:disabled{color:var(--dsw-alias-label-caption);cursor:default}.Z0oESa_showHiddenToggleActive{color:var(--dsw-alias-label-primary)}.Z0oESa_footerGap{flex:1 1 0}.Z0oESa_footerAction{min-width:72px}.Z0oESa_createDialog.Z0oESa_createDialog{gap:0;width:min(380px,100%);padding:0}.Z0oESa_createBody{flex-direction:column;gap:12px;padding:22px 24px 20px;display:flex}.Z0oESa_createTitle{color:var(--dsw-alias-label-primary);margin:0;font-size:16px;font-weight:510;line-height:24px}.Z0oESa_createIn{color:var(--dsw-alias-label-primary);margin:0;font-size:14px;line-height:22px}.Z0oESa_createInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;line-height:22px}.Z0oESa_createInput::placeholder{color:var(--dsw-alias-label-caption)}.Z0oESa_createActions{justify-content:flex-end;align-items:center;gap:8px;margin-top:8px;display:flex}";
		...
		var DirectoryBrowser_module_css_default = {
			"column": "Z0oESa_column",
			"content": "Z0oESa_content",
			"createActions": "Z0oESa_createActions",
			"createBody": "Z0oESa_createBody",
			"createDialog": "Z0oESa_createDialog",
			"createIn": "Z0oESa_createIn",
			"createInput": "Z0oESa_createInput",
			"createTitle": "Z0oESa_createTitle",
			"crumb": "Z0oESa_crumb",
			"crumbBar": "Z0oESa_crumbBar",
			"crumbChevron": "Z0oESa_crumbChevron",
			"crumbEditGlyph": "Z0oESa_crumbEditGlyph",
			"crumbEditZone": "Z0oESa_crumbEditZone",
			"crumbSeat": "Z0oESa_crumbSeat",
			"crumbTrail": "Z0oESa_crumbTrail",
			"dialog": "Z0oESa_dialog",
			"divider": "Z0oESa_divider",
			"editorScope": "Z0oESa_editorScope",
			"error": "Z0oESa_error",
			"footerAction": "Z0oESa_footerAction",
			"footerBar": "Z0oESa_footerBar",
			"footerGap": "Z0oESa_footerGap",
			"header": "Z0oESa_header",
			"loadingFloat": "Z0oESa_loadingFloat",
			"millerRow": "Z0oESa_millerRow",
			"pathInput": "Z0oESa_pathInput",
			"row": "Z0oESa_row",
			"rowChevron": "Z0oESa_rowChevron",
			"rowIcon": "Z0oESa_rowIcon",
			"rowIconSelected": "Z0oESa_rowIconSelected",
			"rowName": "Z0oESa_rowName",
			"rowSeat": "Z0oESa_rowSeat",
			"rowSelected": "Z0oESa_rowSelected",
			"showHiddenToggle": "Z0oESa_showHiddenToggle",
			"showHiddenToggleActive": "Z0oESa_showHiddenToggleActive",
			"status": "Z0oESa_status",
			"title": "Z0oESa_title"
		};
		//#endregion
