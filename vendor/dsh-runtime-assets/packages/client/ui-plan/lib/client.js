window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/Users/chenrongjian/WorkBuddy/DeepSeek/deepseek-harness/packages/client/ui-plan/src/client/PlanModeControl.module.css.mjs
		const css = "._4WR12a_wrap{align-items:center;gap:6px;display:inline-flex}._4WR12a_chip{background:var(--dsw-alias-state-warn-tertiary);min-width:34px;color:var(--dsw-alias-state-warn-label);cursor:pointer;border:none;border-radius:999px;align-items:center;gap:4px;padding:2px 8px;font-size:13px;font-weight:500;line-height:20px;display:inline-flex}._4WR12a_chip:hover:not(:disabled){color:var(--dsw-alias-state-warn-primary)}._4WR12a_chip:focus-visible{outline:2px solid var(--dsw-alias-state-warn-label);outline-offset:2px}._4WR12a_chip:disabled{opacity:.6;cursor:default}._4WR12a_close{color:currentColor;align-items:center;display:inline-flex}._4WR12a_error{color:var(--dsw-alias-state-error-primary);font-size:12px;line-height:18px}";
