window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chenrongjian/WorkBuddy/DeepSeek/deepseek-harness/packages/client/ui-agent-preset/src/client/AgentPresetLabel.module.css.mjs
		const css$3 = ".Vt6yDG_label{background:var(--dsw-alias-fill-tsp-secondary);max-width:180px;height:22px;color:var(--dsw-alias-label-secondary);white-space:nowrap;text-overflow:ellipsis;border-radius:6px;align-items:center;gap:4px;padding:0 2px 0 0;font-size:12px;line-height:22px;display:inline-flex;overflow:hidden}.Vt6yDG_icon{opacity:.7;flex:none}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chenrongjian/WorkBuddy/DeepSeek/deepseek-harness/packages/client/ui-agent-preset/src/client/AgentPresetRow.module.css.mjs
		const css$2 = ".NwH9GW_row{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.NwH9GW_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.NwH9GW_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.NwH9GW_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}.NwH9GW_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.NwH9GW_selector:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.NwH9GW_selector:disabled{cursor:default}.NwH9GW_chevron{flex:none}";
		...
		var AgentPresetRow_module_css_default = {
			"chevron": "NwH9GW_chevron",
			"desc": "NwH9GW_desc",
			"row": "NwH9GW_row",
			"rowText": "NwH9GW_rowText",
			"selector": "NwH9GW_selector",
			"title": "NwH9GW_title"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chenrongjian/WorkBuddy/DeepSeek/deepseek-harness/packages/client/ui-agent-preset/src/client/AgentPresetSeat.module.css.mjs
		const css$1 = "._37fAka_seat{max-width:min(100%,240px);min-height:28px;color:var(--dsw-alias-label-primary);white-space:nowrap;text-overflow:ellipsis;cursor:pointer;background:0 0;border:none;border-radius:16px;align-items:center;gap:4px;padding:0 8px;font-size:13px;font-weight:500;line-height:20px;display:inline-flex;overflow:hidden}._37fAka_seat:not(:disabled):hover,._37fAka_seat[aria-expanded=true]{background:var(--dsw-alias-interactive-bg-hover)}._37fAka_seat:disabled{cursor:default;color:var(--dsw-alias-label-quaternary)}._37fAka_seatIcon{color:var(--dsw-alias-label-primary);flex:none}._37fAka_introIcon{animation:.15s cubic-bezier(.16,1,.3,1) both _37fAka_seat-icon-in}@keyframes _37fAka_seat-icon-in{0%{opacity:0;transform:scale(.5)}to{opacity:1;transform:scale(1)}}._37fAka_introText{white-space:pre;display:inline-block}._37fAka_introChar{white-space:pre;opacity:0;animation:.4s ease-out forwards _37fAka_seat-char-in;display:inline-block}@keyframes _37fAka_seat-char-in{0%{opacity:0;transform:translateY(4px)}to{opacity:1;transform:none}}@media (prefers-reduced-motion:reduce){._37fAka_introIcon,._37fAka_introChar{opacity:1;animation:none}}._37fAka_chevron{color:var(--dsw-alias-label-caption);flex:none}._37fAka_item{flex-direction:column;gap:2px;max-width:280px;display:flex}._37fAka_itemName{color:var(--dsw-alias-label-primary);font-size:13px;line-height:20px}._37fAka_itemDesc{color:var(--dsw-alias-label-caption);white-space:normal;font-size:12px;line-height:16px}";
		...
		var AgentPresetSeat_module_css_default = {
			"chevron": "_37fAka_chevron",
			"introChar": "_37fAka_introChar",
			"introIcon": "_37fAka_introIcon",
			"introText": "_37fAka_introText",
			"item": "_37fAka_item",
			"itemDesc": "_37fAka_itemDesc",
			"itemName": "_37fAka_itemName",
			"seat": "_37fAka_seat",
			"seat-char-in": "_37fAka_seat-char-in",
			"seat-icon-in": "_37fAka_seat-icon-in",
			"seatIcon": "_37fAka_seatIcon"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chenrongjian/WorkBuddy/DeepSeek/deepseek-harness/packages/client/ui-agent-preset/src/client/AgentPresetSection.module.css.mjs
		const css = ".y2fxQa_section{max-width:720px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;display:flex}.y2fxQa_title{margin:0;font-size:18px;font-weight:600}.y2fxQa_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}.y2fxQa_group{flex-direction:column;gap:10px;display:flex}.y2fxQa_group+.y2fxQa_group{margin-top:20px}.y2fxQa_groupHead{letter-spacing:.06em;text-transform:uppercase;color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;font-weight:600}.y2fxQa_cards{grid-template-columns:repeat(auto-fill,minmax(268px,1fr));grid-auto-rows:1fr;gap:12px;margin:0;padding:0;list-style:none;display:grid}.y2fxQa_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;flex-direction:column;transition:border-color .16s,background .16s;display:flex}.y2fxQa_card:hover:not(.y2fxQa_cardActive){border-color:var(--dsw-alias-label-dimmed)}.y2fxQa_cardActive{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-primary)}.y2fxQa_cardBroken,.y2fxQa_cardBroken:hover{border-color:var(--dsw-alias-state-error-primary)}.y2fxQa_brokenBadge{white-space:nowrap;background:var(--dsw-alias-state-error-primary);color:var(--dsw-alias-bg-layer-3);border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.y2fxQa_cardBrokenReason{color:var(--dsw-alias-state-error-primary);overflow-wrap:anywhere;font-size:12px;line-height:1.5}.y2fxQa_cardMain{appearance:none;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px 12px 0 0;flex-direction:column;flex:1;gap:8px;padding:14px 16px 12px;display:flex}.y2fxQa_cardMain:disabled{cursor:default}.y2fxQa_cardMain:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}.y2fxQa_cardHead{align-items:center;gap:8px;display:flex}.y2fxQa_cardName{font-size:15px;font-weight:600;line-height:1.4}.y2fxQa_badge,.y2fxQa_inUse{white-space:nowrap;border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.y2fxQa_badge{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-tertiary)}.y2fxQa_inUse{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);margin-left:auto}.y2fxQa_cardDesc{color:var(--dsw-alias-label-secondary);-webkit-line-clamp:4;overflow-wrap:anywhere;-webkit-box-orient:vertical;min-height:42px;font-size:13px;line-height:1.55;display:-webkit-box;overflow:hidden}.y2fxQa_cardId{font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);color:var(--dsw-alias-label-dimmed);margin-top:auto;font-size:11px}.y2fxQa_cardFoot{border-top:1px solid var(--dsw-alias-border-l2);justify-content:flex-end;gap:2px;padding:6px 10px;display:flex}.y2fxQa_iconButton{appearance:none;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:7px;align-items:center;padding:6px;display:inline-flex;position:relative}.y2fxQa_iconButton:disabled{opacity:.4;cursor:default}.y2fxQa_iconButton:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary)}.y2fxQa_iconButton:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-1px}.y2fxQa_iconButton:after{content:attr(data-tip);background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);white-space:nowrap;opacity:0;pointer-events:none;border-radius:6px;padding:3px 8px;font-size:11px;line-height:17px;transition:opacity .12s;position:absolute;bottom:calc(100% + 6px);left:50%;transform:translate(-50%)}.y2fxQa_iconButton:hover:after,.y2fxQa_iconButton:focus-visible:after{opacity:1}.y2fxQa_iconDanger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.y2fxQa_revealedPath{color:var(--dsw-alias-label-tertiary);align-items:baseline;gap:6px;margin:0;padding:6px 16px 10px;font-size:11px;display:flex}.y2fxQa_revealedPath code{font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);color:var(--dsw-alias-label-secondary);user-select:all;overflow-wrap:anywhere}.y2fxQa_revealedPathLabel{white-space:nowrap}.y2fxQa_secondaryButton{color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border:none;border-radius:7px;padding:5px 8px;font-size:12.5px}.y2fxQa_secondaryButton:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1)}.y2fxQa_secondaryButton:disabled{opacity:.5;cursor:default}.y2fxQa_field{flex-direction:column;gap:6px;display:flex}.y2fxQa_fieldLabel{color:var(--dsw-alias-label-secondary);font-size:12px;font-weight:500}.y2fxQa_input{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);font:inherit;background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);border-radius:10px;padding:9px 12px;font-size:13px}.y2fxQa_input:focus{border-color:var(--dsw-alias-brand-primary);outline:none}.y2fxQa_input::placeholder{color:var(--dsw-alias-label-dimmed)}.y2fxQa_dialog{width:min(560px,100%)}.y2fxQa_dialogFields{flex-direction:column;gap:12px;display:flex}.y2fxQa_viewerCode{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);max-height:min(52vh,480px);color:var(--dsw-alias-label-secondary);font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);white-space:pre;tab-size:2;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:10px;margin:0;padding:12px;font-size:12.5px;line-height:1.5;overflow:auto}.y2fxQa_error{color:var(--dsw-alias-state-error-primary);margin:0;font-size:12px}.y2fxQa_deleteDialog{width:min(480px,100%)}.y2fxQa_deleteConfirm:not(:disabled){border-color:var(--dsw-alias-state-error-primary);color:var(--dsw-alias-state-error-primary)}.y2fxQa_deleteConfirm:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger)}.y2fxQa_creatorButton{box-sizing:border-box;border:1px dashed var(--dsw-alias-border-l3);height:44px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:12px;justify-content:center;align-self:stretch;align-items:center;gap:6px;font-size:14px;line-height:22px;display:flex}.y2fxQa_creatorButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.y2fxQa_creatorButton:disabled{opacity:.4;cursor:default}";
		...
		var AgentPresetSection_module_css_default = {
			"badge": "y2fxQa_badge",
			"brokenBadge": "y2fxQa_brokenBadge",
			"card": "y2fxQa_card",
			"cardActive": "y2fxQa_cardActive",
			"cardBroken": "y2fxQa_cardBroken",
			"cardBrokenReason": "y2fxQa_cardBrokenReason",
			"cardDesc": "y2fxQa_cardDesc",
			"cardFoot": "y2fxQa_cardFoot",
			"cardHead": "y2fxQa_cardHead",
			"cardId": "y2fxQa_cardId",
			"cardMain": "y2fxQa_cardMain",
			"cardName": "y2fxQa_cardName",
			"cards": "y2fxQa_cards",
			"creatorButton": "y2fxQa_creatorButton",
			"deleteConfirm": "y2fxQa_deleteConfirm",
			"deleteDialog": "y2fxQa_deleteDialog",
			"dialog": "y2fxQa_dialog",
			"dialogFields": "y2fxQa_dialogFields",
			"error": "y2fxQa_error",
			"field": "y2fxQa_field",
			"fieldLabel": "y2fxQa_fieldLabel",
			"group": "y2fxQa_group",
			"groupHead": "y2fxQa_groupHead",
			"iconButton": "y2fxQa_iconButton",
			"iconDanger": "y2fxQa_iconDanger",
			"inUse": "y2fxQa_inUse",
			"input": "y2fxQa_input",
			"intro": "y2fxQa_intro",
			"revealedPath": "y2fxQa_revealedPath",
			"revealedPathLabel": "y2fxQa_revealedPathLabel",
			"secondaryButton": "y2fxQa_secondaryButton",
			"section": "y2fxQa_section",
			"title": "y2fxQa_title",
			"viewerCode": "y2fxQa_viewerCode"
		};
		//#endregion
