window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/Users/chenrongjian/WorkBuddy/DeepSeek/deepseek-harness/packages/client/ui-jobs/src/client/JobListAction.module.css.mjs
		const css = ".wYI5da_root{position:relative}.wYI5da_trigger{min-height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;gap:3px;padding:3px 2px;font-size:12px;line-height:18px;display:inline-flex}.wYI5da_trigger:hover,.wYI5da_trigger:focus-visible{color:var(--dsw-alias-label-secondary)}.wYI5da_trigger svg{transition:transform .12s}.wYI5da_triggerOpen{transform:rotate(180deg)}.wYI5da_triggerDot{flex:none}.wYI5da_count{margin:0 5px}.wYI5da_menu{z-index:100;box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-specific-menu);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);width:336px;max-width:min(400px,100vw - 32px);max-height:min(420px,100vh - 140px);box-shadow:var(--dsw-shadow-lv3);border-radius:12px;flex-direction:column;gap:1px;margin:0;padding:4px;list-style:none;display:flex;position:absolute;top:calc(100% + 5px);left:0;overflow:auto}.wYI5da_row{box-sizing:border-box;width:100%;min-height:32px;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:8px;padding:6px 8px;font-size:13px;line-height:18px;display:flex}.wYI5da_rowSettled{color:var(--dsw-alias-label-tertiary)}.wYI5da_rowDot{flex:none}.wYI5da_kind{background:var(--dsw-alias-fill-l2);color:var(--dsw-alias-label-secondary);border-radius:5px;flex:none;padding:0 6px;font-size:11px;line-height:18px}.wYI5da_label{min-width:0;font-family:var(--dsw-font-mono);white-space:nowrap;text-overflow:ellipsis;flex:1;overflow:hidden}.wYI5da_status,.wYI5da_duration{color:var(--dsw-alias-label-tertiary);flex:none;font-size:11px;line-height:18px}.wYI5da_status{white-space:nowrap;text-overflow:ellipsis;max-width:40%;overflow:hidden}.wYI5da_duration{font-variant-numeric:tabular-nums}";
		...
		var JobListAction_module_css_default = {
			"count": "wYI5da_count",
			"duration": "wYI5da_duration",
			"kind": "wYI5da_kind",
			"label": "wYI5da_label",
			"menu": "wYI5da_menu",
			"root": "wYI5da_root",
			"row": "wYI5da_row",
			"rowDot": "wYI5da_rowDot",
			"rowSettled": "wYI5da_rowSettled",
			"status": "wYI5da_status",
			"trigger": "wYI5da_trigger",
			"triggerDot": "wYI5da_triggerDot",
			"triggerOpen": "wYI5da_triggerOpen"
		};
		//#endregion
