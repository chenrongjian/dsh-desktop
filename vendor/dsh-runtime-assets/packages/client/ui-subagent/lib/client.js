window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/Users/chenrongjian/WorkBuddy/DeepSeek/deepseek-harness/packages/client/ui-subagent/src/client/SubagentHeaderLineage.module.css.mjs
		const css$1 = ".-f4W3W_root{align-items:center;gap:10px;min-width:0;display:inline-flex;position:relative}.-f4W3W_switcherRoot{min-width:0;margin-left:6px}.-f4W3W_trigger,.-f4W3W_switcherTrigger{min-height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;padding:3px 2px;font-size:12px;line-height:18px;display:inline-flex}.-f4W3W_trigger{gap:4px}.-f4W3W_switcherTrigger{min-width:0;max-width:244px;color:var(--dsw-alias-label-primary);gap:4px;font-weight:500}.-f4W3W_ancestorSwitcherTrigger{color:var(--dsw-alias-label-tertiary);font-weight:400}.-f4W3W_switcherTitle{text-overflow:ellipsis;white-space:nowrap;flex:1;min-width:0;overflow:hidden}.-f4W3W_switcherTrigger svg{flex:none}.-f4W3W_separator{color:var(--dsw-alias-label-caption);font-size:14px;line-height:20px}.-f4W3W_activitySlot{flex:none;width:10px;height:10px;display:inline-flex}.-f4W3W_trigger:hover,.-f4W3W_trigger:focus-visible{color:var(--dsw-alias-label-secondary)}.-f4W3W_switcherTrigger:hover,.-f4W3W_switcherTrigger:focus-visible{color:var(--dsw-alias-label-primary)}.-f4W3W_ancestorSwitcherTrigger:hover,.-f4W3W_ancestorSwitcherTrigger:focus-visible{color:var(--dsw-alias-label-tertiary)}.-f4W3W_trigger svg,.-f4W3W_switcherTrigger svg{transition:transform .12s}.-f4W3W_triggerOpen{transform:rotate(180deg)}.-f4W3W_menu{z-index:100;box-sizing:border-box;background:var(--dsw-specific-menu);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);width:336px;max-width:min(400px,100vw - 32px);max-height:min(560px,100vh - 140px);box-shadow:var(--dsw-shadow-lv3);border-radius:12px;flex-direction:column;padding:4px;display:flex;position:fixed;overflow:auto}.-f4W3W_node{min-width:0;position:relative}.-f4W3W_menu>.-f4W3W_node{margin-left:-3px}.-f4W3W_row{box-sizing:border-box;width:100%;min-height:50px;color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;background:0 0;border:0;border-radius:8px;outline:none;align-items:flex-start;gap:8px;padding:7px 8px 7px 11px;font-size:13px;line-height:18px;display:flex;position:relative}.-f4W3W_row:hover>.-f4W3W_clickarea,.-f4W3W_row:focus-visible>.-f4W3W_clickarea{background:var(--dsw-alias-interactive-bg-hover)}.-f4W3W_clickarea{box-sizing:border-box;border-radius:8px;flex:1;align-self:stretch;align-items:flex-start;gap:8px;min-width:0;margin:-7px -8px;padding:7px 8px;display:flex}.-f4W3W_row>[data-state],.-f4W3W_clickarea>[data-state]{margin-top:4px}.-f4W3W_disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}.-f4W3W_disabled:hover{background:0 0}.-f4W3W_loadingRow{cursor:default}.-f4W3W_disclosure,.-f4W3W_disclosureSpace{flex:none;width:14px;height:18px}.-f4W3W_disclosure{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;justify-content:center;align-items:center;padding:0;transition:transform .12s;display:inline-flex}.-f4W3W_disclosure:hover{color:var(--dsw-alias-label-primary)}.-f4W3W_disclosureOpen{transform:rotate(90deg)}.-f4W3W_content{flex-direction:column;flex:1;min-width:0;display:flex}.-f4W3W_label,.-f4W3W_summary{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.-f4W3W_label{color:inherit;font-weight:400}.-f4W3W_currentLabel{font-weight:600}.-f4W3W_summary,.-f4W3W_metrics{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:16px}.-f4W3W_metrics{font-variant-numeric:tabular-nums;text-align:right;white-space:nowrap;flex:none;grid-template-rows:18px 16px;display:grid}.-f4W3W_metricToken{grid-row:1;line-height:18px}.-f4W3W_metricDuration{grid-row:2}.-f4W3W_children{margin-left:18px;padding-left:4px;position:relative}.-f4W3W_children:before,.-f4W3W_children>.-f4W3W_node:before{content:\"\";border-left:1px solid var(--dsw-alias-border-l2);position:absolute;left:0}.-f4W3W_children:before{height:26px;top:-26px}.-f4W3W_children[aria-busy=true]:before{content:none}.-f4W3W_children>.-f4W3W_node:before{top:0;bottom:0;left:-4px}.-f4W3W_children>.-f4W3W_node:last-child:before{height:17px;bottom:auto}.-f4W3W_children>.-f4W3W_node>.-f4W3W_row:before{content:\"\";border-top:1px solid var(--dsw-alias-border-l2);width:14px;position:absolute;top:16px;left:-4px}.-f4W3W_notice,.-f4W3W_error{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}.-f4W3W_error{color:var(--dsw-alias-state-error-primary);justify-content:space-between;align-items:center;gap:12px;display:flex}.-f4W3W_refresh{color:inherit;cursor:pointer;background:0 0;border:0;border-radius:6px;flex:none;align-items:center;gap:4px;padding:4px 6px;display:inline-flex}.-f4W3W_refresh:hover{background:var(--dsw-alias-interactive-bg-hover)}";
		...
		var SubagentHeaderLineage_module_css_default = {
			"activitySlot": "-f4W3W_activitySlot",
			"ancestorSwitcherTrigger": "-f4W3W_ancestorSwitcherTrigger",
			"children": "-f4W3W_children",
			"clickarea": "-f4W3W_clickarea",
			"content": "-f4W3W_content",
			"currentLabel": "-f4W3W_currentLabel",
			"disabled": "-f4W3W_disabled",
			"disclosure": "-f4W3W_disclosure",
			"disclosureOpen": "-f4W3W_disclosureOpen",
			"disclosureSpace": "-f4W3W_disclosureSpace",
			"error": "-f4W3W_error",
			"label": "-f4W3W_label",
			"loadingRow": "-f4W3W_loadingRow",
			"menu": "-f4W3W_menu",
			"metricDuration": "-f4W3W_metricDuration",
			"metricToken": "-f4W3W_metricToken",
			"metrics": "-f4W3W_metrics",
			"node": "-f4W3W_node",
			"notice": "-f4W3W_notice",
			"refresh": "-f4W3W_refresh",
			"root": "-f4W3W_root",
			"row": "-f4W3W_row",
			"separator": "-f4W3W_separator",
			"summary": "-f4W3W_summary",
			"switcherRoot": "-f4W3W_switcherRoot",
			"switcherTitle": "-f4W3W_switcherTitle",
			"switcherTrigger": "-f4W3W_switcherTrigger",
			"trigger": "-f4W3W_trigger",
			"triggerOpen": "-f4W3W_triggerOpen"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chenrongjian/WorkBuddy/DeepSeek/deepseek-harness/packages/client/ui-subagent/src/client/SubagentReadOnlyComposer.module.css.mjs
		const css = ".CGpP6G_frame{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);min-height:54px;color:var(--dsw-alias-label-tertiary);border-radius:14px;justify-content:center;align-items:center;gap:8px;margin:0 24px 20px;padding:10px 16px;font-size:13px;line-height:20px;display:flex}.CGpP6G_frame strong{color:var(--dsw-alias-label-primary);font-weight:510}";
		...
		var SubagentReadOnlyComposer_module_css_default = { "frame": "CGpP6G_frame" };
		//#endregion
