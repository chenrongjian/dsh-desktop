window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chenrongjian/WorkBuddy/DeepSeek/deepseek-harness/packages/client/ui-deliverables/src/client/ProducedFiles.module.css.mjs
		const css = ".OMARYW_root{grid-template-columns:max-content minmax(0,1fr);align-items:center;gap:6px 8px;margin-top:16px;font-size:13px;line-height:22px;display:grid;position:relative}.OMARYW_label{color:var(--dsw-alias-label-tertiary);grid-area:1/1}.OMARYW_row{flex-wrap:nowrap;grid-area:1/2;align-items:center;gap:8px;min-width:0;display:flex;overflow:hidden}.OMARYW_file{text-overflow:ellipsis;white-space:nowrap;background:var(--dsw-alias-interactive-bg-hover);max-width:320px;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border:none;border-radius:6px;flex:none;margin:0;padding:0 8px;overflow:hidden}.OMARYW_file:hover{color:var(--dsw-alias-label-primary);text-decoration:underline}.OMARYW_file:focus-visible,.OMARYW_showFolder:focus-visible{box-shadow:inset 0 0 0 2px var(--dsw-alias-border-l3);outline:none}.OMARYW_more{white-space:nowrap;color:var(--dsw-alias-label-tertiary);flex:none}.OMARYW_showFolder{color:var(--dsw-alias-label-tertiary);font:inherit;cursor:pointer;background:0 0;border:none;border-radius:4px;grid-area:2/2;justify-self:start;margin:0;padding:0 2px;line-height:20px}.OMARYW_showFolder:hover{color:var(--dsw-alias-label-secondary);text-decoration:underline}.OMARYW_measure{visibility:hidden;pointer-events:none;contain:strict;width:0;height:0;position:absolute;overflow:hidden}.OMARYW_probe{width:max-content;position:absolute;inset:0 auto auto 0}";
		...
		var ProducedFiles_module_css_default = {
			"file": "OMARYW_file",
			"label": "OMARYW_label",
			"measure": "OMARYW_measure",
			"more": "OMARYW_more",
			"probe": "OMARYW_probe",
			"root": "OMARYW_root",
			"row": "OMARYW_row",
			"showFolder": "OMARYW_showFolder"
		};
		//#endregion
