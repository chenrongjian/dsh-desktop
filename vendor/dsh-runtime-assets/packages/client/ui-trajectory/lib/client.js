window.__ModuleLoader__.load({
 ...
 /* istanbul ignore else */
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chenrongjian/WorkBuddy/DeepSeek/deepseek-harness/packages/client/ui-trajectory/src/client/TrajectoryTable.module.css.mjs
		const css$3 = ".f9nFEG_split{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);background:var(--dsw-alias-bg-layer-1);flex:1;width:100%;min-height:0;display:flex;position:relative;overflow:hidden;container-type:inline-size}.f9nFEG_tablePane{min-width:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);flex:1;position:relative;overflow:hidden auto;container:f9nFEG_trajectory-table/inline-size}.f9nFEG_historyLoading{z-index:5;pointer-events:none;height:0;position:sticky;top:0;overflow:visible}.f9nFEG_historyLoadingBar{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);width:100%;height:30px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxs-12);justify-content:center;align-items:center;gap:6px;display:flex}.f9nFEG_historyLoadingSpinner{box-sizing:border-box;border:1.5px solid var(--dsw-alias-border-l2);border-top-color:var(--dsw-alias-state-business-primary);border-radius:50%;width:10px;height:10px;animation:.7s linear infinite f9nFEG_history-loading-spin}.f9nFEG_table tbody .f9nFEG_historyLoadRow td{height:30px;padding:0}.f9nFEG_table tbody .f9nFEG_historyLoadRow+tr[data-turn-start=true] td:before{content:none}.f9nFEG_historyLoadButton{background:var(--dsw-alias-bg-layer-1);width:100%;height:29px;color:var(--dsw-alias-label-secondary);cursor:pointer;font:var(--dsw-font-xxs-12);border:0;justify-content:center;align-items:center;gap:6px;display:flex}.f9nFEG_historyLoadButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.f9nFEG_historyLoadButton:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px}.f9nFEG_historyLoadButton:disabled{cursor:default}.f9nFEG_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.f9nFEG_table:not([data-scroll-ready=true]){visibility:hidden}@keyframes f9nFEG_history-loading-spin{to{transform:rotate(360deg)}}@media (prefers-reduced-motion:reduce){.f9nFEG_historyLoadingSpinner{animation:none}}.f9nFEG_table{--trajectory-turn-accent:color-mix(in srgb, var(--dsw-static-blue-500) 22%, var(--dsw-alias-bg-layer-1));border-spacing:0;table-layout:fixed;width:100%;min-width:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xxs-12)}.f9nFEG_eventColumn{width:122px}.f9nFEG_contentColumn{width:auto}.f9nFEG_table th{z-index:3;box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);height:30px;color:var(--dsw-alias-label-tertiary);background:var(--dsw-specific-sidebar-fill);font:var(--dsw-font-xxs-12);text-align:left;text-overflow:ellipsis;user-select:none;white-space:nowrap;padding:0 8px;font-weight:500;position:sticky;top:0;overflow:hidden}.f9nFEG_eventHeader{text-align:right!important;padding-right:4px!important}.f9nFEG_table td{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l1);text-overflow:ellipsis;white-space:nowrap;height:30px;padding:0 8px;overflow:hidden}.f9nFEG_table tbody .f9nFEG_virtualSpacer{pointer-events:none}.f9nFEG_table tbody .f9nFEG_virtualSpacer td{height:var(--trajectory-virtual-spacer-height);border:0;padding:0}.f9nFEG_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]){cursor:default;transition:background-color .12s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out);outline:none}.f9nFEG_table tbody tr[data-timeline-focus=outside]{opacity:.24}.f9nFEG_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]):not([data-selected=true]):hover{background:var(--dsw-alias-interactive-bg-hover)}.f9nFEG_table tbody tr[data-request-only=true]:hover{background:0 0}.f9nFEG_table tbody tr[data-request-only=true] td{border-bottom:0;height:0;padding-top:0;padding-bottom:0}.f9nFEG_table tbody tr[data-terminal-request-boundary=true] td{height:9px}.f9nFEG_table tbody tr[data-request-only=true] .f9nFEG_turnRail{top:-15px;bottom:0}.f9nFEG_table tbody tr:not([data-collapsed-summary]):focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}.f9nFEG_table tbody tr[data-selected=true]{background:var(--dsw-alias-interactive-bg-active)}.f9nFEG_requestBoundaryControl{--request-boundary-base-left:12px;z-index:6;top:-8px;left:calc(var(--request-boundary-base-left) + var(--request-boundary-offset,0px));cursor:pointer;background:0 0;border:0;width:16px;height:16px;padding:0;position:absolute}.f9nFEG_requestBoundaryControl:before{background:var(--dsw-alias-label-caption);width:5px;height:5px;box-shadow:0 0 0 2px var(--dsw-alias-bg-layer-1), 0 0 0 3px transparent;content:\"\";transition:background .12s var(--ds-ease-in-out), box-shadow .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:5.5px;left:5.5px}.f9nFEG_requestBoundaryControl:after{border:1px solid var(--dsw-alias-border-l1);width:max-content;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);content:attr(data-label);font:9px/12px var(--ds-font-family-code);opacity:0;pointer-events:none;transition:opacity .12s var(--ds-ease-in-out), transform .12s var(--ds-ease-in-out);user-select:none;white-space:nowrap;border-radius:2px;padding:0 4px;position:absolute;top:2px;left:17px;transform:translate(-2px);box-shadow:0 2px 6px #0000001f}.f9nFEG_requestBoundaryControl:hover:before,.f9nFEG_requestBoundaryControl:focus-visible:before{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color)}.f9nFEG_requestBoundaryControlActive:before,.f9nFEG_requestBoundaryControlActive:hover:before,.f9nFEG_requestBoundaryControlActive:focus-visible:before{background:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 18%, var(--dsw-alias-bg-layer-1));box-shadow:0 0 0 1.5px var(--dsw-alias-brand-primary-new-colorprimary-new-color)}.f9nFEG_requestBoundaryControl[data-request-status=error]:before,.f9nFEG_requestBoundaryControl[data-request-status=error]:hover:before,.f9nFEG_requestBoundaryControl[data-request-status=error]:focus-visible:before{background:var(--dsw-alias-state-error-primary)}.f9nFEG_requestBoundaryControl:hover:after,.f9nFEG_requestBoundaryControl:focus-visible:after{opacity:1;transform:translate(0)}.f9nFEG_requestBoundaryControl:focus-visible{outline:none}.f9nFEG_table tbody tr:has(.f9nFEG_requestBoundaryControl:hover):not([data-selected=true]){background:0 0}.f9nFEG_event{position:relative}.f9nFEG_turnRail,.f9nFEG_selectionRail{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color);pointer-events:none;position:absolute;left:0}.f9nFEG_turnRail{z-index:4;background:var(--trajectory-turn-accent);width:2px;top:-1px;bottom:-1px}.f9nFEG_table tbody tr[data-turn-end=true] .f9nFEG_turnRail{bottom:0}.f9nFEG_selectionRail{z-index:5;width:3px;top:0;bottom:0}.f9nFEG_table tbody tr[data-error=true] .f9nFEG_turnRail{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 22%, var(--dsw-alias-bg-layer-1))}.f9nFEG_table tbody tr[data-error=true] .f9nFEG_selectionRail{background:var(--dsw-alias-state-error-primary)}.f9nFEG_table tbody tr[data-turn-start=true] td{position:relative;overflow:visible}.f9nFEG_table tbody tr[data-turn-start=true]:not(:first-child) td:before{z-index:1;background:var(--dsw-alias-border-l1);content:\"\";pointer-events:none;height:2px;position:absolute;top:0;left:0;right:0;transform:translateY(-50%)}.f9nFEG_event{padding-left:36px!important;padding-right:4px!important;overflow:visible!important}.f9nFEG_turnLabel{z-index:3;box-sizing:border-box;width:max-content;color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-bg-module-platform);font:8px/10px var(--ds-font-family-code);font-variant-numeric:tabular-nums;user-select:none;white-space:nowrap;border-radius:0 0 2px;flex:none;align-items:center;padding:1px 5px;display:inline-grid;position:absolute;top:0;left:0}.f9nFEG_turnLabelFull,.f9nFEG_turnLabelCompact{opacity:1;white-space:nowrap;grid-area:1/1;max-width:64px;overflow:hidden}.f9nFEG_turnLabelCompact{opacity:0;max-width:0}.f9nFEG_turnLabelActive{color:color-mix(in srgb, var(--dsw-static-blue-500) 55%, var(--dsw-alias-label-tertiary));background:var(--trajectory-turn-accent)}.f9nFEG_eventInner{justify-content:flex-start;align-items:center;min-width:0;height:100%;display:flex}.f9nFEG_kindSlot{flex:none;justify-content:flex-end;align-items:flex-end;width:76px;display:flex}.f9nFEG_kindSlot [role=tooltip]{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary)}.f9nFEG_content{color:var(--dsw-alias-label-primary);padding-left:4px!important}.f9nFEG_kindTag{box-sizing:border-box;letter-spacing:.035em;user-select:none;border:1px solid #0000;border-radius:4px;flex:none;align-items:center;height:19px;padding:0 5px;font-size:10px;font-weight:650;line-height:16px;display:inline-flex}.f9nFEG_kindTagIcon{opacity:0;flex:none;justify-content:center;align-items:center;width:0;height:13px;display:inline-flex;overflow:hidden;transform:scale(.8)}.f9nFEG_kindTagLabel{opacity:1;white-space:nowrap;max-width:72px;display:inline-block;overflow:hidden}.f9nFEG_table .f9nFEG_kindSlot .f9nFEG_message{justify-content:center;width:100%}@container f9nFEG_trajectory-table (width<=620px){.f9nFEG_eventColumn{width:50px}.f9nFEG_event{padding-left:28px!important;padding-right:3px!important}.f9nFEG_requestBoundaryControl{--request-boundary-base-left:6px}.f9nFEG_kindSlot{width:19px}.f9nFEG_kindTag,.f9nFEG_table .f9nFEG_kindSlot .f9nFEG_message{justify-content:center;width:19px;padding-left:0;padding-right:0}.f9nFEG_kindTagIcon{opacity:1;width:13px;transform:scale(1)}.f9nFEG_kindTagLabel,.f9nFEG_turnLabelFull{opacity:0;max-width:0}.f9nFEG_turnLabelCompact{opacity:1;max-width:64px}}@media (prefers-reduced-motion:no-preference){.f9nFEG_eventColumn,.f9nFEG_event,.f9nFEG_requestBoundaryControl,.f9nFEG_kindSlot,.f9nFEG_kindTag,.f9nFEG_kindTagIcon,.f9nFEG_kindTagLabel,.f9nFEG_turnLabelFull,.f9nFEG_turnLabelCompact{transition-duration:.18s;transition-timing-function:var(--ds-ease-in-out)}.f9nFEG_eventColumn,.f9nFEG_kindSlot{transition-property:width}.f9nFEG_event{transition-property:padding-right,padding-left}.f9nFEG_requestBoundaryControl{transition-property:left}.f9nFEG_kindTag{transition-property:padding-right,padding-left}.f9nFEG_kindTagIcon{transition-property:width,opacity,transform}.f9nFEG_kindTagLabel,.f9nFEG_turnLabelFull,.f9nFEG_turnLabelCompact{transition-property:max-width,opacity}}.f9nFEG_user{color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-state-business-tertiary)}.f9nFEG_systemNeutral{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}.f9nFEG_contextGreen{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary));background:var(--dsw-alias-state-success-tertiary)}.f9nFEG_compacted{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}.f9nFEG_compactedSummary{font:var(--dsw-font-xs-13);margin-top:12px;padding:0 0 14px}.f9nFEG_promptDiffSections{flex-direction:column;gap:14px;max-height:100%;padding:10px 14px 14px;display:flex;overflow:auto}.f9nFEG_promptDiffSection{min-width:0}.f9nFEG_promptDiffTitle{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0 0 6px}.f9nFEG_promptDiff{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:11px/17px var(--ds-font-family-code);white-space:pre;margin:0;overflow:auto}.f9nFEG_promptDiff span{min-width:max-content;padding:0 6px;display:block}.f9nFEG_promptDiffLinemeta{color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-module-platform);user-select:none}.f9nFEG_promptDiffLinecontext{color:var(--dsw-alias-label-secondary)}.f9nFEG_promptDiffLineadded{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 72%, var(--dsw-alias-label-primary));background:var(--dsw-alias-state-success-tertiary)}.f9nFEG_promptDiffLineremoved{color:var(--dsw-alias-state-error-primary);background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 12%, var(--dsw-alias-bg-layer-1))}.f9nFEG_assistantVioletBright{color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));background:color-mix(in srgb, color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 55%, var(--dsw-alias-state-error-secondary)) 15%, var(--dsw-alias-bg-layer-1))}.f9nFEG_toolAmber{color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary)}.f9nFEG_subtoolAmber{color:color-mix(in srgb, var(--dsw-alias-state-warn-label) 62%, var(--dsw-alias-label-tertiary));background:color-mix(in srgb, var(--dsw-alias-state-warn-tertiary) 58%, var(--dsw-alias-bg-layer-1))}.f9nFEG_contentText{text-overflow:ellipsis;white-space:nowrap;min-width:0;display:block;overflow:hidden}.f9nFEG_toolCallOnly{color:var(--dsw-alias-label-tertiary)}.f9nFEG_table tbody tr[data-collapsed-summary=turn] td,.f9nFEG_table tbody tr[data-collapsed-summary=assistant] td{height:20px}.f9nFEG_table tbody tr[data-collapsed-summary]{cursor:pointer;transition:background-color .12s var(--ds-ease-in-out);outline:none}.f9nFEG_table tbody tr[data-collapsed-summary]:hover{background:var(--dsw-alias-interactive-bg-hover)}.f9nFEG_table tbody tr[data-collapsed-summary]:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}.f9nFEG_collapsedTurnContent{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;font-size:12px;line-height:16px;display:flex}.f9nFEG_collapsedTurnEllipsis{color:var(--dsw-alias-label-tertiary);user-select:none;flex:none;margin-right:6px;font-weight:600}.f9nFEG_collapsedTurnText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.f9nFEG_resultPreview{grid-template-columns:clamp(180px, var(--trajectory-tool-request-width,calc(36cqw - 56px)), 480px) minmax(0, 1fr);align-items:center;gap:8px;min-width:0;display:grid}.f9nFEG_resultRequest,.f9nFEG_inlineResultText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.f9nFEG_toolCallNameTypeface{color:var(--dsw-alias-label-primary);font:400 12px/18px Menlo,Consolas,Liberation Mono,PingFang SC,Microsoft YaHei}.f9nFEG_toolCallPayload{color:var(--dsw-alias-label-secondary);font:400 12px/18px var(--ds-font-family-code);margin-left:7px}.f9nFEG_table tbody tr[data-kind=tool] .f9nFEG_contentText,.f9nFEG_table tbody tr[data-kind=subtool] .f9nFEG_contentText,.f9nFEG_table tbody tr[data-kind=tool] .f9nFEG_resultPreview,.f9nFEG_table tbody tr[data-kind=subtool] .f9nFEG_resultPreview{font-family:var(--ds-font-family-code);font-size:12px}.f9nFEG_table tbody tr[data-kind=subtool] .f9nFEG_content{padding-left:26px}.f9nFEG_inlineResult{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;display:flex}.f9nFEG_noOutputText{color:var(--dsw-alias-label-caption)}.f9nFEG_arrow{color:var(--dsw-alias-label-caption);flex:none;margin-right:8px}.f9nFEG_error,.f9nFEG_overview dd.f9nFEG_error,.f9nFEG_details .f9nFEG_errorPayload{color:var(--dsw-alias-state-error-primary)}.f9nFEG_details .f9nFEG_errorPayload .f9nFEG_resultBlockText{color:inherit}.f9nFEG_details .f9nFEG_jsonPayload.f9nFEG_errorPayload,.f9nFEG_details .f9nFEG_jsonPreview.f9nFEG_errorPayload{--json-tree-property:var(--dsw-alias-state-error-primary);--json-tree-string:var(--dsw-alias-state-error-primary);--json-tree-number:var(--dsw-alias-state-error-primary);--json-tree-keyword:var(--dsw-alias-state-error-primary);--json-tree-punctuation:var(--dsw-alias-state-error-primary);--json-tree-icon:var(--dsw-alias-state-error-primary)}.f9nFEG_details{border-left:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);flex-direction:column;flex:none;width:clamp(320px,38%,440px);min-width:0;max-width:calc(100% - 280px);min-height:0;display:flex;position:relative}.f9nFEG_detailsResizeHandle{z-index:6;cursor:col-resize;touch-action:none;user-select:none;background:0 0;border:0;width:8px;padding:0;position:absolute;top:0;bottom:0;left:-4px}.f9nFEG_detailsResizeHandle:focus-visible{outline:none}.f9nFEG_detailsHeader{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);flex:none;justify-content:space-between;align-items:center;height:42px;padding:0 8px 0 12px;display:flex}.f9nFEG_detailsTitle{min-width:0;color:var(--dsw-alias-label-primary);align-items:center;gap:8px;display:flex}.f9nFEG_requestDetailsDot{background:var(--dsw-alias-label-secondary);border-radius:50%;flex:none;width:5px;height:5px}.f9nFEG_requestDetailsName{font:500 12px/16px var(--ds-font-family-code);flex:none}.f9nFEG_detailsLocation{min-width:0;color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.f9nFEG_close{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:0;border-radius:6px;flex:none;justify-content:center;align-items:center;padding:0;font-size:18px;line-height:18px;display:inline-flex}.f9nFEG_close:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.f9nFEG_detailTabs{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);overscroll-behavior-x:contain;scrollbar-width:none;white-space:nowrap;flex:none;gap:1px;width:100%;min-width:0;max-width:100%;height:34px;padding:0 8px;display:flex;overflow:auto hidden}.f9nFEG_detailTabs::-webkit-scrollbar{display:none}.f9nFEG_detailTab{color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xs-13);background:0 0;border:0;flex:none;padding:0 9px;position:relative}.f9nFEG_detailTab:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.f9nFEG_detailTabActive{color:var(--dsw-alias-state-business-primary)}.f9nFEG_detailTabActive:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:1px 1px 0 0;height:2px;position:absolute;bottom:0;left:9px;right:9px}.f9nFEG_close:focus-visible,.f9nFEG_detailTab:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.f9nFEG_detailBody{min-height:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);scrollbar-gutter:stable;flex:1;overflow:hidden auto}.f9nFEG_detailBodySummary{box-sizing:border-box;padding-bottom:calc(12px + var(--dsh-trajectory-bottom-clearance,0px));flex-direction:column;display:flex;overflow:hidden}.f9nFEG_detailBodySummary>.f9nFEG_overview{overscroll-behavior:contain;flex:0 auto;min-height:0;overflow:auto}.f9nFEG_detailBodySummary>.f9nFEG_compactedSummary{flex:1;min-height:0;overflow:auto}.f9nFEG_summaryScrollRegion{--dsh-scrollbar-thumb:transparent;--dsh-scrollbar-thumb-hover:transparent}.f9nFEG_summaryScrollRegion:hover,.f9nFEG_summaryScrollRegion:focus-within{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2)}.f9nFEG_compactedSummary .f9nFEG_markdownPayload{padding-right:18px}.f9nFEG_overview{font:var(--dsw-font-xs-13);margin:0;padding:8px 0}.f9nFEG_overviewParentLinks{gap:14px;display:flex}.f9nFEG_overviewHierarchyNavLink{all:unset;color:var(--dsw-alias-label-secondary);cursor:pointer;font:inherit;opacity:1;align-items:center;gap:1px;display:inline-flex}.f9nFEG_overviewHierarchyNavLink:hover{color:var(--dsw-alias-label-primary)}.f9nFEG_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-caption);flex:none}.f9nFEG_overviewHierarchyNavLink:hover .f9nFEG_overviewHierarchyJumpIconTight,.f9nFEG_overviewHierarchyNavLink:focus-visible .f9nFEG_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-primary)}.f9nFEG_overviewHierarchyNavLink:focus-visible{color:var(--dsw-alias-label-primary);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.f9nFEG_overview>div{grid-template-columns:94px minmax(0,1fr);align-items:center;min-height:22px;padding:0 14px;display:grid}.f9nFEG_overview>.f9nFEG_requestTokenDetail dt{padding-left:12px}.f9nFEG_usagePanel{padding:4px 0 10px}.f9nFEG_usageGroup+.f9nFEG_usageGroup{margin-top:8px}.f9nFEG_usageHeading{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0;padding:4px 14px 1px}.f9nFEG_usageGroup .f9nFEG_overview{padding:0}.f9nFEG_overview dt{color:var(--dsw-alias-label-tertiary)}.f9nFEG_overview dd{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;margin:0;overflow:hidden}.f9nFEG_timestampToggle{all:unset;color:inherit;cursor:pointer;font:inherit;user-select:text}.f9nFEG_timestampToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.f9nFEG_overviewSections{border-top:0;flex-direction:column;flex:1;min-height:min-content;display:flex;overflow:hidden}.f9nFEG_overviewSection{flex-direction:column;flex:1 1 0;min-height:28px;max-height:max-content;display:flex;overflow:hidden}.f9nFEG_overviewSection+.f9nFEG_overviewSection{padding-top:8px}.f9nFEG_overviewHeading{box-sizing:border-box;width:100%;height:28px;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xs-strong-13);user-select:none;flex:none;align-items:flex-end;margin:0;padding:0 0 3px 14px;display:flex}.f9nFEG_overviewTitle{width:max-content;height:auto;color:inherit;cursor:pointer;font:inherit;user-select:none;background:0 0;border:0;flex:none;align-items:center;gap:3px;padding:0;line-height:1;display:inline-flex}.f9nFEG_overviewTitleIcon{color:var(--dsw-alias-label-caption);flex:none}.f9nFEG_overviewTitle:hover .f9nFEG_overviewTitleIcon{color:var(--dsw-alias-label-primary)}.f9nFEG_overviewTitle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.f9nFEG_overviewTitle:focus-visible .f9nFEG_overviewTitleIcon{color:var(--dsw-alias-state-business-primary)}.f9nFEG_overviewPreview{overscroll-behavior:contain;background:var(--dsw-alias-bg-layer-1);flex:1;min-height:0;overflow:auto}.f9nFEG_overviewPreview>:last-child{margin-bottom:0;padding-bottom:0}.f9nFEG_overviewPreview .f9nFEG_jsonPreview>:first-child,.f9nFEG_overviewPreview .f9nFEG_schemaTree>:first-child{padding-bottom:0}.f9nFEG_overviewPreview .f9nFEG_schemaTree{margin-bottom:0}.f9nFEG_overviewPreview .f9nFEG_overview{padding:2px 0 0}.f9nFEG_overviewPreview .f9nFEG_overview>div{min-height:22px}.f9nFEG_markdownPreview,.f9nFEG_markdownPayload{color:var(--dsw-alias-label-primary)}.f9nFEG_markdownPreview>div,.f9nFEG_markdownPayload>div{font:var(--dsw-font-xs-13);gap:8px}.f9nFEG_markdownPreview>div h1,.f9nFEG_markdownPayload>div h1{font:600 16px/22px var(--dsw-font-family)}.f9nFEG_markdownPreview>div h2,.f9nFEG_markdownPayload>div h2{font:600 15px/22px var(--dsw-font-family)}.f9nFEG_markdownPreview>div :where(h3,h4,h5,h6),.f9nFEG_markdownPayload>div :where(h3,h4,h5,h6){font:600 14px/20px var(--dsw-font-family)}.f9nFEG_markdownPreview>div :not(pre)>code,.f9nFEG_markdownPayload>div :not(pre)>code{font:12px/18px var(--ds-font-family-code)}.f9nFEG_markdownPreview>div table,.f9nFEG_markdownPayload>div table{font:var(--dsw-font-xs-13)}.f9nFEG_markdownPreview>div>:first-child{margin-top:0}.f9nFEG_markdownPreview>div>:last-child{margin-bottom:0}.f9nFEG_markdownPreview>div :where(h1,h2,h3){margin:12px 0 6px}.f9nFEG_markdownPreview>div :where(h4,h5,h6){margin:10px 0 5px}.f9nFEG_markdownPreview>div :where(p,ul,ol){margin:8px 0}.f9nFEG_markdownPreview>div li:not(:first-child){margin-top:3px}.f9nFEG_markdownPreview>div blockquote{margin-top:8px}.f9nFEG_markdownPreview>div hr{margin:14px 0}.f9nFEG_markdownPreview>div>.md-code-block{margin:10px 0}.f9nFEG_assistantContent .f9nFEG_markdownPayload,.f9nFEG_assistantContent .f9nFEG_payload{min-height:0}.f9nFEG_thinkingQuote{border-left:2px solid var(--dsw-alias-markdown-citation);color:var(--dsw-alias-label-secondary);background:0 0;margin:6px 14px 0 12px;padding-left:6px}.f9nFEG_thinkingQuoteOnlyPreview{margin-bottom:8px}.f9nFEG_detailBody>.f9nFEG_assistantContentRendered .f9nFEG_thinkingQuote{margin-top:14px}.f9nFEG_thinkingToggle{width:max-content;height:18px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:600 12px/18px var(--dsw-font-family);user-select:none;background:0 0;border:0;align-items:center;gap:2px;padding:0;display:flex}.f9nFEG_thinkingChevron{transition:transform .12s var(--ds-ease-in-out);flex:none}.f9nFEG_thinkingToggle[aria-expanded=true] .f9nFEG_thinkingChevron{transform:rotate(90deg)}.f9nFEG_thinkingToggle:hover{color:var(--dsw-alias-label-secondary)}.f9nFEG_thinkingToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.f9nFEG_thinkingQuote .f9nFEG_markdownPreview,.f9nFEG_thinkingQuote .f9nFEG_markdownPayload,.f9nFEG_thinkingQuote .f9nFEG_payload{min-height:0;color:var(--dsw-alias-label-secondary);background:0 0;padding:2px 0}.f9nFEG_assistantOutput{background:var(--dsw-alias-bg-layer-1)}.f9nFEG_markdownPreview{padding:6px 14px 8px}.f9nFEG_markdownPayload{min-height:100%;padding:14px}.f9nFEG_jsonPayload{min-height:100%}.f9nFEG_jsonPreview{min-height:0}.f9nFEG_schema{background:var(--dsw-alias-bg-layer-1);min-height:100%}.f9nFEG_schemaPreview{min-height:0}.f9nFEG_schemaIntro{padding:12px 14px 6px}.f9nFEG_schemaPreview .f9nFEG_schemaIntro{padding-top:6px}.f9nFEG_schemaName{color:var(--dsw-alias-label-primary);font:600 12px/18px var(--ds-font-family-code);margin:0}.f9nFEG_schemaDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:2px 0 0}.f9nFEG_schemaParameters{min-width:0}.f9nFEG_schemaParametersTitle{color:var(--dsw-alias-label-tertiary);font:600 11px/16px var(--dsw-font-family);user-select:none;margin:0;padding:4px 14px 2px}.f9nFEG_schemaTree{margin:0 6px 8px 0}.f9nFEG_payload{box-sizing:border-box;overflow-wrap:anywhere;min-height:100%;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-markdown-code-block);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;margin:0;padding:14px}.f9nFEG_payloadPreview{min-height:0;padding:6px 14px 8px}.f9nFEG_sourceBlocks{box-sizing:border-box;min-height:100%;padding:12px 14px}.f9nFEG_sourceBlock+.f9nFEG_sourceBlock{margin-top:14px}.f9nFEG_sourceBlockHeader,.f9nFEG_sourceBlockJumpTarget{user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}.f9nFEG_sourceBlockJumpTarget{all:unset;cursor:pointer;user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}.f9nFEG_sourceBlockLabel{color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code)}.f9nFEG_sourceBlockJumpIcon{color:var(--dsw-alias-label-caption);flex:none}.f9nFEG_sourceBlockJumpTarget:hover .f9nFEG_sourceBlockJumpIcon{color:var(--dsw-alias-label-primary)}.f9nFEG_sourceBlockJumpTarget:focus-visible{outline:none}.f9nFEG_sourceBlockJumpTarget:focus-visible .f9nFEG_sourceBlockJumpIcon{color:var(--dsw-alias-state-business-primary)}.f9nFEG_sourceBlockContent{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}.f9nFEG_panelImageLink{cursor:zoom-in;border-radius:4px;width:auto;max-width:100%;display:block;overflow:hidden}.f9nFEG_panelImageLinkPreview{max-height:140px}.f9nFEG_panelImage{border-radius:inherit;background:var(--dsw-alias-bg-base);object-fit:contain;width:auto;max-width:100%;height:auto;max-height:320px;margin:0;display:block}.f9nFEG_panelImageLinkPreview .f9nFEG_panelImage{max-height:140px}.f9nFEG_messageImages{flex-direction:column;gap:8px;margin:8px 14px 14px;display:flex}.f9nFEG_messageImagesPreview{gap:6px;margin:6px 14px 8px}.f9nFEG_assistantToolCalls{box-sizing:border-box;max-width:100%;color:var(--dsw-alias-label-secondary);font:11px/17px var(--ds-font-family-code);margin:2px 14px 12px;padding:0;list-style:none}.f9nFEG_assistantToolCallsPreview{margin-top:2px;margin-bottom:8px}.f9nFEG_assistantToolCalls li{min-width:0}.f9nFEG_assistantToolCallButton{all:unset;box-sizing:border-box;cursor:pointer;border-radius:3px;align-items:center;width:calc(100% + 4px);min-width:0;height:19px;margin-left:-4px;padding:0 4px;display:flex}.f9nFEG_assistantToolCallButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.f9nFEG_assistantToolCallButton:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.f9nFEG_assistantToolCallIcon{color:var(--dsw-alias-label-caption);flex:none;margin-right:5px}.f9nFEG_assistantToolCallButton:hover .f9nFEG_assistantToolCallIcon,.f9nFEG_assistantToolCallButton:focus-visible .f9nFEG_assistantToolCallIcon{color:var(--dsw-alias-label-secondary)}.f9nFEG_assistantToolCallText{white-space:nowrap;flex:1;min-width:0;display:flex;overflow:hidden}.f9nFEG_assistantToolCallName{color:var(--dsw-alias-label-secondary);flex:none;margin-right:5px;font-weight:500}.f9nFEG_assistantToolCallArgs{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.f9nFEG_systemPrompt{box-sizing:border-box}.f9nFEG_toolCatalog{min-height:100%;padding:8px 0 16px}.f9nFEG_toolCatalogItem{border-bottom:1px solid var(--dsw-alias-border-l1)}.f9nFEG_toolCatalogSummary{box-sizing:border-box;cursor:pointer;user-select:none;grid-template-columns:12px 12px max-content minmax(0,1fr);align-items:center;gap:5px;min-height:30px;padding:4px 12px;list-style:none;display:grid}.f9nFEG_toolCatalogSummary::-webkit-details-marker{display:none}.f9nFEG_toolCatalogSummary:hover{background:var(--dsw-alias-interactive-bg-hover)}.f9nFEG_toolCatalogSummary:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.f9nFEG_toolCatalogChevron,.f9nFEG_toolCatalogIcon{color:var(--dsw-alias-label-caption)}.f9nFEG_toolCatalogChevron{transition:transform .1s var(--ds-ease-in-out)}.f9nFEG_toolCatalogItem[open] .f9nFEG_toolCatalogChevron{transform:rotate(90deg)}.f9nFEG_toolCatalogName{color:var(--dsw-alias-label-primary);font:500 12px/18px var(--ds-font-family-code)}.f9nFEG_toolCatalogDescription{min-width:0;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.f9nFEG_toolCatalogDefinition{background:var(--dsw-alias-bg-base);padding:0 0 8px 29px}.f9nFEG_toolCatalogFullDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:0;padding:7px 14px 4px 0}.f9nFEG_toolCatalogTree{margin-left:-14px;margin-right:6px}.f9nFEG_resultBlocks{box-sizing:border-box;flex-direction:column;gap:10px;min-height:100%;padding:14px;display:flex}.f9nFEG_resultBlocksPreview{gap:6px;min-height:0;padding:6px 14px 8px}.f9nFEG_resultBlockText{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}.f9nFEG_overviewPreview .f9nFEG_noPayload{padding:6px 14px 8px}.f9nFEG_noPayload{color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:0;padding:18px 14px}@media (width<=760px){.f9nFEG_details{z-index:5;border-left-color:var(--dsw-alias-border-l3);width:min(92%,420px);max-width:92%;position:absolute;top:0;bottom:0;right:0;box-shadow:-12px 0 32px #00000024}}";
		...
		var TrajectoryTable_module_css_default = {
			"arrow": "f9nFEG_arrow",
			"assistantContent": "f9nFEG_assistantContent",
			"assistantContentRendered": "f9nFEG_assistantContentRendered",
			"assistantOutput": "f9nFEG_assistantOutput",
			"assistantToolCallArgs": "f9nFEG_assistantToolCallArgs",
			"assistantToolCallButton": "f9nFEG_assistantToolCallButton",
			"assistantToolCallIcon": "f9nFEG_assistantToolCallIcon",
			"assistantToolCallName": "f9nFEG_assistantToolCallName",
			"assistantToolCallText": "f9nFEG_assistantToolCallText",
			"assistantToolCalls": "f9nFEG_assistantToolCalls",
			"assistantToolCallsPreview": "f9nFEG_assistantToolCallsPreview",
			"assistantVioletBright": "f9nFEG_assistantVioletBright",
			"close": "f9nFEG_close",
			"collapsedTurnContent": "f9nFEG_collapsedTurnContent",
			"collapsedTurnEllipsis": "f9nFEG_collapsedTurnEllipsis",
			"collapsedTurnText": "f9nFEG_collapsedTurnText",
			"compacted": "f9nFEG_compacted",
			"compactedSummary": "f9nFEG_compactedSummary",
			"content": "f9nFEG_content",
			"contentColumn": "f9nFEG_contentColumn",
			"contentText": "f9nFEG_contentText",
			"contextGreen": "f9nFEG_contextGreen",
			"detailBody": "f9nFEG_detailBody",
			"detailBodySummary": "f9nFEG_detailBodySummary",
			"detailTab": "f9nFEG_detailTab",
			"detailTabActive": "f9nFEG_detailTabActive",
			"detailTabs": "f9nFEG_detailTabs",
			"details": "f9nFEG_details",
			"detailsHeader": "f9nFEG_detailsHeader",
			"detailsLocation": "f9nFEG_detailsLocation",
			"detailsResizeHandle": "f9nFEG_detailsResizeHandle",
			"detailsTitle": "f9nFEG_detailsTitle",
			"error": "f9nFEG_error",
			"errorPayload": "f9nFEG_errorPayload",
			"event": "f9nFEG_event",
			"eventColumn": "f9nFEG_eventColumn",
			"eventHeader": "f9nFEG_eventHeader",
			"eventInner": "f9nFEG_eventInner",
			"history-loading-spin": "f9nFEG_history-loading-spin",
			"historyLoadButton": "f9nFEG_historyLoadButton",
			"historyLoadRow": "f9nFEG_historyLoadRow",
			"historyLoading": "f9nFEG_historyLoading",
			"historyLoadingBar": "f9nFEG_historyLoadingBar",
			"historyLoadingSpinner": "f9nFEG_historyLoadingSpinner",
			"inlineResult": "f9nFEG_inlineResult",
			"inlineResultText": "f9nFEG_inlineResultText",
			"jsonPayload": "f9nFEG_jsonPayload",
			"jsonPreview": "f9nFEG_jsonPreview",
			"kindSlot": "f9nFEG_kindSlot",
			"kindTag": "f9nFEG_kindTag",
			"kindTagIcon": "f9nFEG_kindTagIcon",
			"kindTagLabel": "f9nFEG_kindTagLabel",
			"markdownPayload": "f9nFEG_markdownPayload",
			"markdownPreview": "f9nFEG_markdownPreview",
			"message": "f9nFEG_message",
			"messageImages": "f9nFEG_messageImages",
			"messageImagesPreview": "f9nFEG_messageImagesPreview",
			"noOutputText": "f9nFEG_noOutputText",
			"noPayload": "f9nFEG_noPayload",
			"overview": "f9nFEG_overview",
			"overviewHeading": "f9nFEG_overviewHeading",
			"overviewHierarchyJumpIconTight": "f9nFEG_overviewHierarchyJumpIconTight",
			"overviewHierarchyNavLink": "f9nFEG_overviewHierarchyNavLink",
			"overviewParentLinks": "f9nFEG_overviewParentLinks",
			"overviewPreview": "f9nFEG_overviewPreview",
			"overviewSection": "f9nFEG_overviewSection",
			"overviewSections": "f9nFEG_overviewSections",
			"overviewTitle": "f9nFEG_overviewTitle",
			"overviewTitleIcon": "f9nFEG_overviewTitleIcon",
			"panelImage": "f9nFEG_panelImage",
			"panelImageLink": "f9nFEG_panelImageLink",
			"panelImageLinkPreview": "f9nFEG_panelImageLinkPreview",
			"payload": "f9nFEG_payload",
			"payloadPreview": "f9nFEG_payloadPreview",
			"promptDiff": "f9nFEG_promptDiff",
			"promptDiffLineadded": "f9nFEG_promptDiffLineadded",
			"promptDiffLinecontext": "f9nFEG_promptDiffLinecontext",
			"promptDiffLinemeta": "f9nFEG_promptDiffLinemeta",
			"promptDiffLineremoved": "f9nFEG_promptDiffLineremoved",
			"promptDiffSection": "f9nFEG_promptDiffSection",
			"promptDiffSections": "f9nFEG_promptDiffSections",
			"promptDiffTitle": "f9nFEG_promptDiffTitle",
			"requestBoundaryControl": "f9nFEG_requestBoundaryControl",
			"requestBoundaryControlActive": "f9nFEG_requestBoundaryControlActive",
			"requestDetailsDot": "f9nFEG_requestDetailsDot",
			"requestDetailsName": "f9nFEG_requestDetailsName",
			"requestTokenDetail": "f9nFEG_requestTokenDetail",
			"resultBlockText": "f9nFEG_resultBlockText",
			"resultBlocks": "f9nFEG_resultBlocks",
			"resultBlocksPreview": "f9nFEG_resultBlocksPreview",
			"resultPreview": "f9nFEG_resultPreview",
			"resultRequest": "f9nFEG_resultRequest",
			"schema": "f9nFEG_schema",
			"schemaDescription": "f9nFEG_schemaDescription",
			"schemaIntro": "f9nFEG_schemaIntro",
			"schemaName": "f9nFEG_schemaName",
			"schemaParameters": "f9nFEG_schemaParameters",
			"schemaParametersTitle": "f9nFEG_schemaParametersTitle",
			"schemaPreview": "f9nFEG_schemaPreview",
			"schemaTree": "f9nFEG_schemaTree",
			"selectionRail": "f9nFEG_selectionRail",
			"sourceBlock": "f9nFEG_sourceBlock",
			"sourceBlockContent": "f9nFEG_sourceBlockContent",
			"sourceBlockHeader": "f9nFEG_sourceBlockHeader",
			"sourceBlockJumpIcon": "f9nFEG_sourceBlockJumpIcon",
			"sourceBlockJumpTarget": "f9nFEG_sourceBlockJumpTarget",
			"sourceBlockLabel": "f9nFEG_sourceBlockLabel",
			"sourceBlocks": "f9nFEG_sourceBlocks",
			"split": "f9nFEG_split",
			"subtoolAmber": "f9nFEG_subtoolAmber",
			"summaryScrollRegion": "f9nFEG_summaryScrollRegion",
			"systemNeutral": "f9nFEG_systemNeutral",
			"systemPrompt": "f9nFEG_systemPrompt",
			"table": "f9nFEG_table",
			"tablePane": "f9nFEG_tablePane",
			"thinkingChevron": "f9nFEG_thinkingChevron",
			"thinkingQuote": "f9nFEG_thinkingQuote",
			"thinkingQuoteOnlyPreview": "f9nFEG_thinkingQuoteOnlyPreview",
			"thinkingToggle": "f9nFEG_thinkingToggle",
			"timestampToggle": "f9nFEG_timestampToggle",
			"toolAmber": "f9nFEG_toolAmber",
			"toolCallNameTypeface": "f9nFEG_toolCallNameTypeface",
			"toolCallOnly": "f9nFEG_toolCallOnly",
			"toolCallPayload": "f9nFEG_toolCallPayload",
			"toolCatalog": "f9nFEG_toolCatalog",
			"toolCatalogChevron": "f9nFEG_toolCatalogChevron",
			"toolCatalogDefinition": "f9nFEG_toolCatalogDefinition",
			"toolCatalogDescription": "f9nFEG_toolCatalogDescription",
			"toolCatalogFullDescription": "f9nFEG_toolCatalogFullDescription",
			"toolCatalogIcon": "f9nFEG_toolCatalogIcon",
			"toolCatalogItem": "f9nFEG_toolCatalogItem",
			"toolCatalogName": "f9nFEG_toolCatalogName",
			"toolCatalogSummary": "f9nFEG_toolCatalogSummary",
			"toolCatalogTree": "f9nFEG_toolCatalogTree",
			"trajectory-table": "f9nFEG_trajectory-table",
			"turnLabel": "f9nFEG_turnLabel",
			"turnLabelActive": "f9nFEG_turnLabelActive",
			"turnLabelCompact": "f9nFEG_turnLabelCompact",
			"turnLabelFull": "f9nFEG_turnLabelFull",
			"turnRail": "f9nFEG_turnRail",
			"usageGroup": "f9nFEG_usageGroup",
			"usageHeading": "f9nFEG_usageHeading",
			"usagePanel": "f9nFEG_usagePanel",
			"user": "f9nFEG_user",
			"virtualSpacer": "f9nFEG_virtualSpacer",
			"visuallyHidden": "f9nFEG_visuallyHidden"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chenrongjian/WorkBuddy/DeepSeek/deepseek-harness/packages/client/ui-trajectory/src/client/TrajectoryToolbar.module.css.mjs
		const css$2 = ".oDDfhq_root{z-index:4;box-sizing:border-box;width:100%;height:var(--dsh-trajectory-toolbar-height);border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);position:sticky;top:0}.oDDfhq_inner{box-sizing:border-box;align-items:center;gap:8px;width:100%;height:100%;padding:0 6px;display:flex}.oDDfhq_actions{flex:none;align-items:center;gap:2px;display:flex}.oDDfhq_toggle{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 7px;display:inline-flex}.oDDfhq_toggle:hover,.oDDfhq_toggle[aria-pressed=true]{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.oDDfhq_toggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.oDDfhq_toggleIcon{stroke:currentColor;stroke-width:1.25px;stroke-linecap:round;stroke-linejoin:round;flex:none;width:12px;height:12px}.oDDfhq_control{box-sizing:border-box;width:88px;height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:0;flex:none;justify-content:center;align-items:center;gap:4px;padding:0 5px;display:inline-flex}.oDDfhq_control[hidden]{display:none}.oDDfhq_control:hover:not(:disabled),.oDDfhq_control[aria-checked=true],.oDDfhq_control[aria-pressed=true]{color:var(--dsw-alias-label-primary)}.oDDfhq_control:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.oDDfhq_control:disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}.oDDfhq_controlTrack{background:var(--dsw-alias-border-l2);width:20px;height:10px;transition:background-color .12s var(--ds-ease-in-out);border-radius:5px;flex:none;display:inline-block;position:relative}.oDDfhq_controlThumb{background:var(--dsw-alias-bg-layer-1);width:6px;height:6px;transition:transform .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:2px;left:2px}.oDDfhq_controlTrack[data-on=true]{background:var(--dsw-alias-state-business-primary)}.oDDfhq_controlTrack[data-on=true] .oDDfhq_controlThumb{transform:translate(10px)}.oDDfhq_action{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 5px;display:inline-flex}.oDDfhq_action:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.oDDfhq_action:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.oDDfhq_actionIcon{color:var(--dsw-alias-label-tertiary);font:14px/14px var(--ds-font-family-code)}.oDDfhq_search{border:1px solid var(--dsw-alias-border-l2);min-width:84px;height:22px;color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-layer-2);border-radius:4px;flex:0 164px;align-items:center;gap:4px;margin-left:auto;padding:0 6px;display:flex}.oDDfhq_search:hover{border-color:var(--dsw-alias-label-caption)}.oDDfhq_search:focus-within{border-color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-bg-layer-1)}.oDDfhq_searchIcon{flex:none}.oDDfhq_searchInput{width:100%;min-width:0;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);background:0 0;border:0;outline:0;padding:0}.oDDfhq_searchInput::placeholder{color:var(--dsw-alias-label-caption)}.oDDfhq_searchInput::-webkit-search-cancel-button{cursor:pointer;width:12px;height:12px}";
		...
		var TrajectoryToolbar_module_css_default = {
			"action": "oDDfhq_action",
			"actionIcon": "oDDfhq_actionIcon",
			"actions": "oDDfhq_actions",
			"control": "oDDfhq_control",
			"controlThumb": "oDDfhq_controlThumb",
			"controlTrack": "oDDfhq_controlTrack",
			"inner": "oDDfhq_inner",
			"root": "oDDfhq_root",
			"search": "oDDfhq_search",
			"searchIcon": "oDDfhq_searchIcon",
			"searchInput": "oDDfhq_searchInput",
			"toggle": "oDDfhq_toggle",
			"toggleIcon": "oDDfhq_toggleIcon"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chenrongjian/WorkBuddy/DeepSeek/deepseek-harness/packages/client/ui-trajectory/src/client/TrajectoryTimeline.module.css.mjs
		const css$1 = ".Q_4wfa_root{z-index:1;isolation:isolate;border-bottom:1px solid var(--dsw-alias-border-l2);user-select:none;flex:none;position:relative}.Q_4wfa_root [role=tooltip]{font:var(--dsw-font-xxxs-11)}.Q_4wfa_plot{background:var(--dsw-alias-bg-layer-2);grid-template-columns:44px minmax(0,1fr);height:50px;display:grid;overflow:hidden}.Q_4wfa_labels{border-right:1px solid var(--dsw-alias-border-l1);color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);font-size:10px;line-height:1;position:relative}.Q_4wfa_labels span{text-align:right;justify-content:flex-end;align-items:center;height:8px;display:flex;position:absolute;right:3px}.Q_4wfa_labels span:first-child{top:7px}.Q_4wfa_labels span:nth-child(2){top:21px}.Q_4wfa_labels span:nth-child(3){top:35px}.Q_4wfa_track{cursor:crosshair;touch-action:none;position:relative;overflow:hidden}.Q_4wfa_track[data-panning=true]{cursor:grabbing}.Q_4wfa_earlierHistory{z-index:5;appearance:none;box-sizing:border-box;background:linear-gradient(to right, var(--dsw-alias-bg-layer-2) 0, var(--dsw-alias-bg-layer-2) 38%, transparent 100%);width:28px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);opacity:.72;cursor:pointer;border:0;outline:none;justify-content:flex-start;align-items:center;padding-left:3px;line-height:1;display:flex;position:absolute;top:0;bottom:0;left:0}.Q_4wfa_earlierHistory:hover{opacity:1}.Q_4wfa_earlierHistory[aria-disabled=true]{cursor:default}.Q_4wfa_earlierHistory:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-border-l2)}.Q_4wfa_empty{color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}.Q_4wfa_track:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.Q_4wfa_lanes{z-index:2;top:7px;bottom:7px;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);position:absolute}.Q_4wfa_turnBoundaries{z-index:3;top:0;bottom:0;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);pointer-events:none;position:absolute}@media (prefers-reduced-motion:no-preference){.Q_4wfa_lanes[data-animate-viewport=true],.Q_4wfa_turnBoundaries[data-animate-viewport=true]{transition:left .18s ease-out}}.Q_4wfa_turnBoundary{top:0;bottom:0;left:var(--trajectory-turn-left);background:var(--dsw-alias-border-l2);width:1px;position:absolute}.Q_4wfa_span{top:calc(var(--trajectory-span-lane) * 14px);left:calc(var(--trajectory-span-left) + var(--trajectory-span-gap));width:max(2px, calc(var(--trajectory-span-width) - var(--trajectory-span-gap) - var(--trajectory-span-gap)));background:var(--dsw-alias-label-secondary);opacity:.78;border-radius:1px;min-width:2px;height:8px;position:absolute}.Q_4wfa_span[data-timeline-span=user]{background:var(--dsw-alias-state-business-primary)}.Q_4wfa_span[data-timeline-span=context]{background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary))}.Q_4wfa_span[data-timeline-span=message]{--trajectory-assistant-decoding-color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));--trajectory-assistant-ttft-color:color-mix(in srgb, var(--trajectory-assistant-decoding-color) 54%, var(--dsw-alias-bg-layer-2));background:var(--trajectory-assistant-decoding-color);opacity:1}.Q_4wfa_span[data-timeline-span=message][data-assistant-timing=true]{background:linear-gradient(to right, var(--trajectory-assistant-ttft-color) 0, var(--trajectory-assistant-ttft-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) 100%)}.Q_4wfa_span[data-timeline-span=tool],.Q_4wfa_span[data-timeline-span=subtool]{background:var(--dsw-alias-state-warn-label);opacity:1}.Q_4wfa_span[data-error=true]{background:var(--dsw-alias-state-error-primary)}.Q_4wfa_span[data-equal-duration=true]{width:8px;min-width:8px}.Q_4wfa_span[data-selected=false]{opacity:.2}.Q_4wfa_span[data-hovered=true]:not([data-current=true]){z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px color-mix(in srgb, var(--dsw-alias-state-business-primary) 80%, transparent)}.Q_4wfa_span[data-current=true]{z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px var(--dsw-alias-state-business-primary)}.Q_4wfa_span[data-search-match=false]{opacity:.14}.Q_4wfa_selection{z-index:1;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 12%, transparent);min-width:1px;box-shadow:-100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent), 100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent);pointer-events:none;position:absolute}.Q_4wfa_selectionEdges{z-index:4;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);pointer-events:none;min-width:1px;position:absolute}.Q_4wfa_hoverLine{z-index:4;top:0;bottom:0;left:clamp(0px, calc(var(--trajectory-hover-left) - 1px), calc(100% - 2px));background:var(--dsw-alias-state-business-primary);pointer-events:none;width:2px;position:absolute}.Q_4wfa_selectionEdges:before,.Q_4wfa_selectionEdges:after{background:var(--dsw-alias-state-business-primary);content:\"\";width:3px;position:absolute;top:0;bottom:0}.Q_4wfa_selectionEdges:before{left:0}.Q_4wfa_selectionEdges:after{right:0}.Q_4wfa_selectionEdges[data-dragging=true]:before,.Q_4wfa_selectionEdges[data-dragging=true]:after{width:2px}.Q_4wfa_selection[data-dragging=true]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 18%, transparent)}";
		...
		var TrajectoryTimeline_module_css_default = {
			"earlierHistory": "Q_4wfa_earlierHistory",
			"empty": "Q_4wfa_empty",
			"hoverLine": "Q_4wfa_hoverLine",
			"labels": "Q_4wfa_labels",
			"lanes": "Q_4wfa_lanes",
			"plot": "Q_4wfa_plot",
			"root": "Q_4wfa_root",
			"selection": "Q_4wfa_selection",
			"selectionEdges": "Q_4wfa_selectionEdges",
			"span": "Q_4wfa_span",
			"track": "Q_4wfa_track",
			"turnBoundaries": "Q_4wfa_turnBoundaries",
			"turnBoundary": "Q_4wfa_turnBoundary"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chenrongjian/WorkBuddy/DeepSeek/deepseek-harness/packages/client/ui-trajectory/src/client/views.module.css.mjs
		const css = "._0UFlBW_root{--dsh-trajectory-toolbar-height:32px;box-sizing:border-box;width:100%;height:100%;min-height:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);flex-direction:column;display:flex;overflow:hidden}._0UFlBW_ledger{z-index:0;isolation:isolate;--dsh-trajectory-bottom-clearance:calc(var(--dsh-composer-height,152px) + 16px);flex:1;min-width:0;min-height:0;display:flex;position:relative;overflow:hidden}";
