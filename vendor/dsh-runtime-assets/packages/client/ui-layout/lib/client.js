window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chenrongjian/WorkBuddy/DeepSeek/deepseek-harness/packages/client/ui-layout/src/client/AppFrame.module.css.mjs
		const css = ".KHOg0q_frame{background:var(--dsw-alias-bg-base);height:100%;transition:grid-template-columns var(--ds-transition-duration-slow) var(--ds-ease-in-out);grid-template-rows:100%;display:grid;position:relative;overflow:hidden}.KHOg0q_frame[data-dragging]{transition:none}@media (prefers-reduced-motion:reduce){.KHOg0q_frame{transition:none}}.KHOg0q_sidebarCol{background:var(--dsw-specific-sidebar-fill);border-right:1px solid var(--dsw-alias-border-l1);min-width:0;overflow:hidden}.KHOg0q_centerCol{flex-direction:column;min-width:0;display:flex;overflow:hidden}.KHOg0q_detailsCol{border-left:1px solid var(--dsw-alias-border-l2);min-width:0;overflow:hidden}.KHOg0q_frame[data-details-collapsed] .KHOg0q_detailsCol{border-left:none}.KHOg0q_handle{cursor:col-resize;z-index:2;touch-action:none;width:8px;transition:left var(--ds-transition-duration-slow) var(--ds-ease-in-out);margin-left:-4px;position:absolute;top:0;bottom:0}.KHOg0q_frame[data-dragging] .KHOg0q_handle{transition:none}@media (prefers-reduced-motion:reduce){.KHOg0q_handle{transition:none}}.KHOg0q_handle[data-side=details]:after{content:\"\";box-sizing:border-box;background:var(--dsw-alias-button-floating-fill);border:1px solid var(--dsw-alias-border-l2-darkmode-thin);opacity:0;width:12px;height:32px;transition:opacity var(--ds-transition-duration-slow) var(--ds-ease-in-out), background var(--ds-transition-duration-slow) var(--ds-ease-in-out);border-radius:10px;position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}.KHOg0q_detailsCol:hover~.KHOg0q_handle[data-side=details]:after,.KHOg0q_handle[data-side=details]:hover:after,.KHOg0q_handle[data-side=details][data-dragging=true]:after{opacity:1}.KHOg0q_handle[data-side=details]:hover:after,.KHOg0q_handle[data-side=details][data-dragging=true]:after{background:var(--dsw-alias-button-floating-hover);border-color:var(--dsw-alias-border-l3)}.KHOg0q_overlayLayer{z-index:20;pointer-events:none;position:absolute;inset:0}.KHOg0q_overlayLayer>*{pointer-events:auto}";
		...
		var AppFrame_module_css_default = {
			"centerCol": "KHOg0q_centerCol",
			"detailsCol": "KHOg0q_detailsCol",
			"frame": "KHOg0q_frame",
			"handle": "KHOg0q_handle",
			"overlayLayer": "KHOg0q_overlayLayer",
			"sidebarCol": "KHOg0q_sidebarCol"
		};
		//#endregion
