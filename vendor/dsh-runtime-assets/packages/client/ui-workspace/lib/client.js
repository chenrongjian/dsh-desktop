window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chenrongjian/WorkBuddy/DeepSeek/deepseek-harness/packages/client/ui-workspace/src/client/rows/Rows.module.css.mjs
		const css$2 = ".DHIj7a_projectRow,.DHIj7a_sessionRow{cursor:pointer;user-select:none;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:6px;padding:0 8px;display:flex}.DHIj7a_projectRow:hover,.DHIj7a_sessionRow:hover,.DHIj7a_sessionRow.DHIj7a_selected{background:var(--dsw-alias-interactive-bg-hover)}.DHIj7a_searchResultRow{box-sizing:border-box;cursor:pointer;text-align:left;width:100%;min-height:48px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:8px;flex-direction:column;align-items:stretch;padding:4px 8px;display:flex}.DHIj7a_searchResultRow:hover,.DHIj7a_searchResultRow.DHIj7a_selected{background:var(--dsw-alias-interactive-bg-hover)}.DHIj7a_searchResultHeading{align-items:center;min-width:0;display:flex}.DHIj7a_searchResultTitle{text-overflow:ellipsis;white-space:nowrap;min-width:0;margin-left:4px;font-size:14px;line-height:20px;overflow:hidden}.DHIj7a_searchResultMeta{align-items:center;gap:6px;min-width:0;margin-left:20px;display:flex}.DHIj7a_searchResultWorkspace,.DHIj7a_searchResultSnippet{text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:17px;overflow:hidden}.DHIj7a_searchResultWorkspace{max-width:40%;color:var(--dsw-alias-label-tertiary);flex:none}.DHIj7a_searchResultSnippet{min-width:0;color:var(--dsw-alias-label-secondary);flex:1}.DHIj7a_projectRow{box-sizing:border-box;align-items:center;height:34px}.DHIj7a_projectRow .DHIj7a_rowActions{height:20px}.DHIj7a_sessionRow{height:32px;animation:DHIj7a_row-in .15s var(--ds-ease-in-out);gap:0}.DHIj7a_sessionRow .DHIj7a_title{margin:0 6px 0 4px}.DHIj7a_flatSessionRowWithoutStatus .DHIj7a_title{margin-left:0}@keyframes DHIj7a_row-in{0%{opacity:0}}.DHIj7a_slot{width:16px;height:20px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;display:inline-flex}.DHIj7a_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.DHIj7a_folderActive{color:var(--dsw-alias-state-business-primary)}.DHIj7a_projectRow .DHIj7a_chevron{display:none}.DHIj7a_projectRow:hover .DHIj7a_chevron{display:inline-flex}.DHIj7a_projectRow:hover .DHIj7a_folder{display:none}.DHIj7a_arrow{transition:transform .15s var(--ds-ease-in-out)}.DHIj7a_arrowOpen{transform:rotate(90deg)}.DHIj7a_projectText{flex-direction:column;flex:1;gap:2px;min-width:0;display:flex}.DHIj7a_title{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:14px;line-height:20px;overflow:hidden}.DHIj7a_renameInput{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-button-elevated-fill);min-width:0;color:inherit;border-radius:4px;outline:none;padding:0 2px;font-size:14px;line-height:20px}.DHIj7a_sessionRow .DHIj7a_title{flex:1}.DHIj7a_meta{text-overflow:ellipsis;white-space:nowrap;color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:20px;overflow:hidden}.DHIj7a_time{color:var(--dsw-alias-label-tertiary);flex:none;font-size:12px;line-height:20px}.DHIj7a_dot{flex:none}.DHIj7a_rowActions{flex:none;align-items:center;gap:12px;display:none}.DHIj7a_projectRow:hover .DHIj7a_rowActions,.DHIj7a_sessionRow:hover .DHIj7a_rowActions,.DHIj7a_projectRow.DHIj7a_menuOpen .DHIj7a_rowActions,.DHIj7a_sessionRow.DHIj7a_menuOpen .DHIj7a_rowActions{display:inline-flex}.DHIj7a_sessionRow:hover .DHIj7a_time,.DHIj7a_sessionRow.DHIj7a_menuOpen .DHIj7a_time{display:none}.DHIj7a_projectRow.DHIj7a_menuOpen,.DHIj7a_sessionRow.DHIj7a_menuOpen{background:var(--dsw-alias-interactive-bg-hover)}.DHIj7a_sessionRow.DHIj7a_dropBefore,.DHIj7a_sessionRow.DHIj7a_dropAfter{position:relative}.DHIj7a_sessionRow.DHIj7a_dropBefore:before,.DHIj7a_sessionRow.DHIj7a_dropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:4px}.DHIj7a_sessionRow.DHIj7a_dropBefore:before{top:-7px}.DHIj7a_sessionRow.DHIj7a_dropAfter:after{bottom:-7px}.DHIj7a_hoverContent{flex-direction:column;gap:8px;display:flex}.DHIj7a_hoverTitle{color:#fff;overflow-wrap:break-word;font-size:14px;line-height:20px}.DHIj7a_hoverPath{color:#cfd3d6;word-break:break-all;font-size:12px;line-height:16px}.DHIj7a_hoverTime{color:#cfd3d6;font-size:12px;line-height:16px}.DHIj7a_hoverStatus{color:#adb2b8;align-items:center;gap:8px;font-size:12px;line-height:20px;display:flex}.DHIj7a_iconButton{cursor:pointer;width:16px;height:16px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:4px;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.DHIj7a_iconButton:hover{color:var(--dsw-alias-label-primary)}.DHIj7a_chevron{color:var(--dsw-alias-label-caption)}@media (prefers-reduced-motion:reduce){.DHIj7a_sessionRow,.DHIj7a_arrow{transition:none;animation:none}}";
		...
		var Rows_module_css_default = {
			"arrow": "DHIj7a_arrow",
			"arrowOpen": "DHIj7a_arrowOpen",
			"chevron": "DHIj7a_chevron",
			"dot": "DHIj7a_dot",
			"dropAfter": "DHIj7a_dropAfter",
			"dropBefore": "DHIj7a_dropBefore",
			"flatSessionRowWithoutStatus": "DHIj7a_flatSessionRowWithoutStatus",
			"folder": "DHIj7a_folder",
			"folderActive": "DHIj7a_folderActive",
			"hoverContent": "DHIj7a_hoverContent",
			"hoverPath": "DHIj7a_hoverPath",
			"hoverStatus": "DHIj7a_hoverStatus",
			"hoverTime": "DHIj7a_hoverTime",
			"hoverTitle": "DHIj7a_hoverTitle",
			"iconButton": "DHIj7a_iconButton",
			"menuOpen": "DHIj7a_menuOpen",
			"meta": "DHIj7a_meta",
			"projectRow": "DHIj7a_projectRow",
			"projectText": "DHIj7a_projectText",
			"renameInput": "DHIj7a_renameInput",
			"row-in": "DHIj7a_row-in",
			"rowActions": "DHIj7a_rowActions",
			"searchResultHeading": "DHIj7a_searchResultHeading",
			"searchResultMeta": "DHIj7a_searchResultMeta",
			"searchResultRow": "DHIj7a_searchResultRow",
			"searchResultSnippet": "DHIj7a_searchResultSnippet",
			"searchResultTitle": "DHIj7a_searchResultTitle",
			"searchResultWorkspace": "DHIj7a_searchResultWorkspace",
			"selected": "DHIj7a_selected",
			"sessionRow": "DHIj7a_sessionRow",
			"slot": "DHIj7a_slot",
			"time": "DHIj7a_time",
			"title": "DHIj7a_title",
			"visuallyHidden": "DHIj7a_visuallyHidden"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chenrongjian/WorkBuddy/DeepSeek/deepseek-harness/packages/client/ui-workspace/src/client/WorkspacePicker.module.css.mjs
		const css$1 = "._4-ldWW_modalAction{min-width:72px}._4-ldWW_modalError,._4-ldWW_menuStatus{margin-top:8px;font-size:12px;line-height:18px}._4-ldWW_modalError{color:var(--dsw-alias-state-error-primary)}._4-ldWW_menuStatus{color:var(--dsw-alias-label-secondary)}";
		...
		var WorkspacePicker_module_css_default = {
			"menuStatus": "_4-ldWW_menuStatus",
			"modalAction": "_4-ldWW_modalAction",
			"modalError": "_4-ldWW_modalError"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chenrongjian/WorkBuddy/DeepSeek/deepseek-harness/packages/client/ui-workspace/src/client/WorkspaceBrowser.module.css.mjs
		const css = ".J5du4G_root{--dsh-session-list-edge-inset:var(--dsh-sidebar-inline-padding);--dsh-session-list-scrollbar-width:8px;--dsh-session-list-scrollbar-offset:2px;box-sizing:border-box;min-height:0;padding-right:var(--dsh-session-list-edge-inset);flex-direction:column;flex:1;display:flex}.J5du4G_root.J5du4G_rail{padding-right:0}.J5du4G_iconButton{cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.J5du4G_iconButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.J5du4G_sectionHeader{box-sizing:border-box;height:36px;color:var(--dsw-alias-label-tertiary);border-radius:12px;flex:none;justify-content:flex-end;align-items:center;gap:4px;margin-bottom:4px;padding-left:4px;display:flex;overflow:hidden}.J5du4G_root:not(.J5du4G_rail) .J5du4G_sectionHeader{margin-top:2px;margin-right:-4px}.J5du4G_sectionLabel{white-space:nowrap;opacity:1;visibility:visible;min-width:0;max-width:45%;transition:max-width .18s var(--ds-ease-in-out), margin-right .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;line-height:20px;overflow:hidden}.J5du4G_sectionLabelHidden{opacity:0;visibility:hidden;max-width:0;margin-right:-4px;transition-delay:0s,0s,0s,0s,.18s;transform:translate(-4px)}.J5du4G_searchSlot{box-sizing:border-box;min-width:0;max-width:28px;transition:max-width .18s var(--ds-ease-in-out), padding-left .18s var(--ds-ease-in-out);flex:1;align-items:center;margin-left:auto;padding-left:0;display:flex}.J5du4G_searchSlotExpanded{max-width:100%;padding-left:0}.J5du4G_headerActions{opacity:1;visibility:visible;max-width:60px;transition:max-width .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;align-items:center;gap:4px;display:flex;overflow:hidden}.J5du4G_headerActionsHidden{opacity:0;visibility:hidden;pointer-events:none;max-width:0;transition-delay:0s,0s,0s,.18s;transform:translate(4px)}.J5du4G_search{box-sizing:border-box;cursor:text;width:100%;height:28px;color:var(--dsw-alias-label-secondary);transition:width .18s var(--ds-ease-in-out), padding .18s var(--ds-ease-in-out), border-color .18s var(--ds-ease-in-out), background-color .18s var(--ds-ease-in-out);background:0 0;border:none;border-radius:50%;flex:none;align-items:center;gap:0;margin:0;padding:0;display:flex;overflow:hidden}.J5du4G_searchExpanded{border:1px solid var(--dsw-alias-border-l2);width:calc(100% + 4px);height:30px;color:var(--dsw-alias-label-caption);background:0 0;border-radius:10px;margin-inline:-2px;padding:0 4px 0 0}.J5du4G_searchButton{cursor:pointer;width:28px;height:28px;color:inherit;background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.J5du4G_searchExpanded .J5du4G_searchButton{width:28px;height:30px}.J5du4G_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.J5du4G_searchExpanded .J5du4G_searchButton:hover{background:0 0}.J5du4G_searchInput{opacity:0;pointer-events:none;width:0;min-width:0;color:var(--dsw-alias-label-primary);transition:opacity .12s var(--ds-ease-in-out);background:0 0;border:none;outline:none;flex:1;font-size:13px;line-height:18px}.J5du4G_searchExpanded .J5du4G_searchInput{opacity:1;pointer-events:auto;margin-left:-2px}.J5du4G_searchInput::placeholder{color:var(--dsw-alias-label-tertiary)}.J5du4G_clearButton{cursor:pointer;width:24px;height:24px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.J5du4G_clearButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.J5du4G_rail .J5du4G_sectionHeader{justify-content:flex-start;gap:0;margin-bottom:12px;padding-left:0}.J5du4G_rail .J5du4G_headerActions{max-width:none}.J5du4G_rail .J5du4G_iconButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}.J5du4G_rail .J5du4G_search{background:0 0;border-color:#0000;gap:0;width:36px;height:36px;margin:0 0 12px;padding:0}.J5du4G_rail .J5du4G_searchButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}.J5du4G_rail .J5du4G_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.J5du4G_listArea{min-height:0;margin-left:-4px;margin-right:calc(-1 * var(--dsh-session-list-edge-inset));flex-direction:column;flex:1;padding-left:4px;display:flex;overflow:visible}.J5du4G_rail .J5du4G_listArea{margin-left:0;margin-right:0;padding-left:0}.J5du4G_treeBody{flex-direction:column;flex:1;min-height:0;display:flex;position:relative}.J5du4G_fade{left:0;right:var(--dsh-session-list-edge-inset);background:linear-gradient(to bottom, transparent, var(--dsw-specific-sidebar-fill));pointer-events:none;height:24px;position:absolute;bottom:0}.J5du4G_wide{animation:J5du4G_wide-in .2s var(--ds-ease-in-out)}@keyframes J5du4G_wide-in{0%{opacity:0}}.J5du4G_list{min-height:0;margin-left:-4px;margin-right:var(--dsh-session-list-scrollbar-offset);padding-left:4px;padding-right:calc(var(--dsh-session-list-edge-inset) - var(--dsh-session-list-scrollbar-width) - var(--dsh-session-list-scrollbar-offset));scrollbar-gutter:stable;flex:1;padding-bottom:16px;overflow-y:auto}.J5du4G_flatList>*+*,.J5du4G_searchTree>[role=treeitem]+[role=treeitem],.J5du4G_groupSection>*+*{margin-top:2px}.J5du4G_searchStatus,.J5du4G_searchWarning{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}.J5du4G_searchWarning{color:var(--dsw-alias-label-secondary)}.J5du4G_groupSection{position:relative}.J5du4G_groupSection+.J5du4G_groupSection{margin-top:4px}.J5du4G_listTopDropIndicator,.J5du4G_workspaceDropBefore:before,.J5du4G_workspaceDropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:0}.J5du4G_listTopDropIndicator{top:-8px;left:0;right:var(--dsh-session-list-edge-inset)}.J5du4G_listTopDropActive>.J5du4G_workspaceDropBefore:first-child:before{display:none}.J5du4G_workspaceDropBefore:before{top:-8px}.J5du4G_workspaceDropAfter:after{bottom:-8px}.J5du4G_sessionOverflowButton{cursor:pointer;text-align:left;width:100%;height:28px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:8px;padding:0 12px 0 28px;font-size:12px}.J5du4G_groupSection>.J5du4G_sessionOverflowButton{margin-top:0}.J5du4G_sessionOverflowButton:hover{color:var(--dsw-alias-label-secondary);background:0 0}.J5du4G_empty{color:var(--dsw-alias-label-tertiary);padding:16px 12px;font-size:13px}.J5du4G_renameInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;font-weight:400;line-height:22px}.J5du4G_renameInput:disabled{color:var(--dsw-alias-label-dimmed)}.J5du4G_renameError{color:var(--dsw-alias-state-error-primary);margin-top:8px;font-size:12px;line-height:18px}.J5du4G_deleteAction:not(:disabled){color:var(--dsw-alias-state-error-primary)}.J5du4G_deleteStatus{color:var(--dsw-alias-label-secondary);font-size:12px;line-height:18px}@media (prefers-reduced-motion:reduce){.J5du4G_wide{animation:none}.J5du4G_search,.J5du4G_sectionLabel,.J5du4G_searchSlot,.J5du4G_searchInput,.J5du4G_headerActions{transition:none}}";
		...
		var WorkspaceBrowser_module_css_default = {
			"clearButton": "J5du4G_clearButton",
			"deleteAction": "J5du4G_deleteAction",
			"deleteStatus": "J5du4G_deleteStatus",
			"empty": "J5du4G_empty",
			"fade": "J5du4G_fade",
			"flatList": "J5du4G_flatList",
			"groupSection": "J5du4G_groupSection",
			"headerActions": "J5du4G_headerActions",
			"headerActionsHidden": "J5du4G_headerActionsHidden",
			"iconButton": "J5du4G_iconButton",
			"list": "J5du4G_list",
			"listArea": "J5du4G_listArea",
			"listTopDropActive": "J5du4G_listTopDropActive",
			"listTopDropIndicator": "J5du4G_listTopDropIndicator",
			"rail": "J5du4G_rail",
			"renameError": "J5du4G_renameError",
			"renameInput": "J5du4G_renameInput",
			"root": "J5du4G_root",
			"search": "J5du4G_search",
			"searchButton": "J5du4G_searchButton",
			"searchExpanded": "J5du4G_searchExpanded",
			"searchInput": "J5du4G_searchInput",
			"searchSlot": "J5du4G_searchSlot",
			"searchSlotExpanded": "J5du4G_searchSlotExpanded",
			"searchStatus": "J5du4G_searchStatus",
			"searchTree": "J5du4G_searchTree",
			"searchWarning": "J5du4G_searchWarning",
			"sectionHeader": "J5du4G_sectionHeader",
			"sectionLabel": "J5du4G_sectionLabel",
			"sectionLabelHidden": "J5du4G_sectionLabelHidden",
			"sessionOverflowButton": "J5du4G_sessionOverflowButton",
			"treeBody": "J5du4G_treeBody",
			"wide": "J5du4G_wide",
			"wide-in": "J5du4G_wide-in",
			"workspaceDropAfter": "J5du4G_workspaceDropAfter",
			"workspaceDropBefore": "J5du4G_workspaceDropBefore"
		};
		//#endregion
