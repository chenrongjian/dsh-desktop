window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chenrongjian/WorkBuddy/DeepSeek/deepseek-harness/packages/client/ui-tool/src/client/tool/components/ToolRow.module.css.mjs
		const css$3 = ".QoxRkG_root{flex-direction:column;display:flex}.QoxRkG_row{position:relative;overflow:hidden}.QoxRkG_root[data-state=running] .QoxRkG_row:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite QoxRkG_dsh-tool-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes QoxRkG_dsh-tool-row-sweep{0%{left:-300px}90%,to{left:100%}}.QoxRkG_leading{flex-shrink:0}.QoxRkG_root[data-tool^=cordis_] .QoxRkG_leading,.QoxRkG_root[data-tool^=cordis_] .QoxRkG_title{color:var(--dsw-alias-state-business-primary)}.QoxRkG_root[data-tool^=cordis_] .QoxRkG_title{font-weight:500}.QoxRkG_root[data-tool^=cordis_] .QoxRkG_sep{background:var(--dsw-alias-state-business-primary)}.QoxRkG_chevron{color:var(--dsw-alias-label-secondary)}.QoxRkG_title{font-weight:400}.QoxRkG_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.QoxRkG_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.QoxRkG_summarySuffix{white-space:nowrap;color:var(--dsw-alias-label-tertiary);flex:none;margin-left:4px;font-size:14px;line-height:24px}.QoxRkG_fileLink{text-overflow:ellipsis;white-space:nowrap;min-width:0;font:inherit;text-align:left;color:var(--dsw-alias-label-secondary);text-decoration:underline;text-decoration-color:var(--dsw-alias-label-quaternary);text-underline-offset:3px;cursor:pointer;background:0 0;border:none;flex:auto;margin:0;padding:0;font-size:14px;line-height:24px;overflow:hidden}.QoxRkG_fileLink:hover{color:var(--dsw-alias-label-primary);text-decoration-color:currentColor}.QoxRkG_errorSummary{color:var(--dsw-alias-state-error-primary)}.QoxRkG_bodyWrap{flex-direction:column;display:flex}.QoxRkG_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.QoxRkG_root:hover .QoxRkG_inspectButton,.QoxRkG_inspectButton:focus-visible{opacity:1}.QoxRkG_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.QoxRkG_bodyScroll{max-height:260px;overflow-y:auto}.QoxRkG_ioCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.QoxRkG_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.QoxRkG_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.QoxRkG_ioSection::-webkit-scrollbar-track{margin:6px 0}.QoxRkG_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.QoxRkG_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:1px}.QoxRkG_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.QoxRkG_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.QoxRkG_codeBody,.QoxRkG_terminalBody,.QoxRkG_diffBody,.QoxRkG_readBody,.QoxRkG_searchBody,.QoxRkG_webBody{margin:4px 0 4px 4px}.QoxRkG_searchRecovery{white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-xs-13);color:var(--dsw-alias-label-tertiary);margin:4px 0 4px 4px}.QoxRkG_codeBody{--dsl-code-block-content-font:var(--dsw-font-markdown-code-block-small)}.QoxRkG_terminalBody{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:1px solid var(--dsw-alias-border-l1)}.QoxRkG_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var ToolRow_module_css_default = {
			"bodyScroll": "QoxRkG_bodyScroll",
			"bodyWrap": "QoxRkG_bodyWrap",
			"chevron": "QoxRkG_chevron",
			"codeBody": "QoxRkG_codeBody",
			"diffBody": "QoxRkG_diffBody",
			"dsh-tool-row-sweep": "QoxRkG_dsh-tool-row-sweep",
			"errorSummary": "QoxRkG_errorSummary",
			"fileLink": "QoxRkG_fileLink",
			"inspectButton": "QoxRkG_inspectButton",
			"ioCard": "QoxRkG_ioCard",
			"ioDivider": "QoxRkG_ioDivider",
			"ioLabel": "QoxRkG_ioLabel",
			"ioSection": "QoxRkG_ioSection",
			"ioText": "QoxRkG_ioText",
			"leading": "QoxRkG_leading",
			"readBody": "QoxRkG_readBody",
			"root": "QoxRkG_root",
			"row": "QoxRkG_row",
			"searchBody": "QoxRkG_searchBody",
			"searchRecovery": "QoxRkG_searchRecovery",
			"sep": "QoxRkG_sep",
			"summary": "QoxRkG_summary",
			"summarySuffix": "QoxRkG_summarySuffix",
			"terminalBody": "QoxRkG_terminalBody",
			"title": "QoxRkG_title",
			"visuallyHidden": "QoxRkG_visuallyHidden",
			"webBody": "QoxRkG_webBody"
		};
		//#endregion
		...
		*  summary already describe a settled row). */
		...
		//#endregion
		//#region \0dsh-css:/Users/chenrongjian/WorkBuddy/DeepSeek/deepseek-harness/packages/client/ui-tool/src/client/tool/ToolCallTree.module.css.mjs
		const css$2 = ".A46dra_callRow{border-radius:6px}.A46dra_subCalls{border-left:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:4px;margin:4px 0 2px 22px;padding-left:8px;display:flex}";
		...
		var ToolCallTree_module_css_default = {
			"callRow": "A46dra_callRow",
			"subCalls": "A46dra_subCalls"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chenrongjian/WorkBuddy/DeepSeek/deepseek-harness/packages/client/ui-tool/src/client/tool/ToolDetails.module.css.mjs
		const css$1 = ".jVkR9G_description{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);margin:0 0 6px}.jVkR9G_cardBody{margin:0}.jVkR9G_recovery{white-space:pre-wrap;overflow-wrap:anywhere;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:6px 0 0}.jVkR9G_code{background:var(--dsw-alias-markdown-code-block);font-family:var(--ds-font-family-code);color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;border-radius:12px;margin:0;padding:16px;font-size:13px;line-height:22px}.jVkR9G_code[data-error]{color:var(--dsw-alias-state-error-primary)}.jVkR9G_read,.jVkR9G_web{margin:0}.jVkR9G_empty{color:var(--dsw-alias-label-tertiary);padding:8px 0;font-size:13px;line-height:20px}";
		...
		var ToolDetails_module_css_default = {
			"cardBody": "jVkR9G_cardBody",
			"code": "jVkR9G_code",
			"description": "jVkR9G_description",
			"empty": "jVkR9G_empty",
			"read": "jVkR9G_read",
			"recovery": "jVkR9G_recovery",
			"web": "jVkR9G_web"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chenrongjian/WorkBuddy/DeepSeek/deepseek-harness/packages/client/ui-tool/src/client/tool/toolviews/bash-sample.module.css.mjs
		const css = ".M7hBPG_card{flex-direction:column;display:flex}.M7hBPG_terminal{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:1px solid var(--dsw-alias-border-l1);margin:4px 0 4px 4px}.M7hBPG_ioCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.M7hBPG_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.M7hBPG_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.M7hBPG_ioSection::-webkit-scrollbar-track{margin:6px 0}.M7hBPG_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.M7hBPG_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:1px}.M7hBPG_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.M7hBPG_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.M7hBPG_root[data-expandable]{cursor:pointer}.M7hBPG_root{align-items:center;min-width:0;height:24px;display:flex;position:relative;overflow:hidden}.M7hBPG_root[data-state=running]:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite M7hBPG_dsh-bash-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes M7hBPG_dsh-bash-row-sweep{0%{left:-300px}90%,to{left:100%}}.M7hBPG_leading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex;position:relative}.M7hBPG_chevron{color:var(--dsw-alias-label-secondary)}.M7hBPG_iconIdle{opacity:1;transition:opacity .1s;display:inline-flex}.M7hBPG_chevronHover{opacity:0;margin:auto;transition:opacity .1s;position:absolute;inset:0}.M7hBPG_root:hover .M7hBPG_iconIdle{opacity:0}.M7hBPG_root:hover .M7hBPG_chevronHover{opacity:1}.M7hBPG_title{color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px}.M7hBPG_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.M7hBPG_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.M7hBPG_errorSummary{color:var(--dsw-alias-state-error-primary)}.M7hBPG_bodyWrap{flex-direction:column;display:flex}.M7hBPG_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.M7hBPG_card:hover .M7hBPG_inspectButton,.M7hBPG_inspectButton:focus-visible{opacity:1}.M7hBPG_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.M7hBPG_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var bash_sample_module_css_default = {
			"bodyWrap": "M7hBPG_bodyWrap",
			"card": "M7hBPG_card",
			"chevron": "M7hBPG_chevron",
			"chevronHover": "M7hBPG_chevronHover",
			"dsh-bash-row-sweep": "M7hBPG_dsh-bash-row-sweep",
			"errorSummary": "M7hBPG_errorSummary",
			"iconIdle": "M7hBPG_iconIdle",
			"inspectButton": "M7hBPG_inspectButton",
			"ioCard": "M7hBPG_ioCard",
			"ioDivider": "M7hBPG_ioDivider",
			"ioLabel": "M7hBPG_ioLabel",
			"ioSection": "M7hBPG_ioSection",
			"ioText": "M7hBPG_ioText",
			"leading": "M7hBPG_leading",
			"root": "M7hBPG_root",
			"sep": "M7hBPG_sep",
			"summary": "M7hBPG_summary",
			"terminal": "M7hBPG_terminal",
			"title": "M7hBPG_title",
			"visuallyHidden": "M7hBPG_visuallyHidden"
		};
		//#endregion
