window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/Users/chenrongjian/WorkBuddy/DeepSeek/deepseek-harness/packages/client/ui-skill/src/client/SkillRow.module.css.mjs
		const css = ".m2EMIa_card{flex-direction:column;display:flex}.m2EMIa_row{align-items:center;min-width:0;height:24px;display:flex;position:relative;overflow:hidden}.m2EMIa_row[data-expandable]{cursor:pointer}.m2EMIa_card[data-state=running] .m2EMIa_row:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite m2EMIa_dsh-skill-row-sweep;position:absolute;inset:0 auto 0 0}@keyframes m2EMIa_dsh-skill-row-sweep{0%{left:-300px}90%,to{left:100%}}.m2EMIa_leading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex;position:relative}.m2EMIa_chevron{color:var(--dsw-alias-label-secondary)}.m2EMIa_iconIdle{opacity:1;transition:opacity .1s;display:inline-flex}.m2EMIa_chevronHover{opacity:0;margin:auto;transition:opacity .1s;position:absolute;inset:0}.m2EMIa_row:hover .m2EMIa_iconIdle{opacity:0}.m2EMIa_row:hover .m2EMIa_chevronHover{opacity:1}.m2EMIa_title{color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px}.m2EMIa_separator{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.m2EMIa_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.m2EMIa_errorSummary{color:var(--dsw-alias-state-error-primary)}.m2EMIa_bodyWrap{flex-direction:column;display:flex}.m2EMIa_instructionsCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);border-radius:12px;flex-direction:column;max-height:260px;margin:4px 0 4px 4px;display:flex;overflow:hidden}.m2EMIa_instructionsHeader{border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block-banner);color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;flex:none;padding:8px 12px;font-size:11px;font-weight:500;line-height:16px}.m2EMIa_instructions{white-space:pre-wrap;overflow-wrap:anywhere;min-height:0;font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-secondary);margin:0;padding:10px 12px 12px;overflow:auto}.m2EMIa_instructions[data-error]{color:var(--dsw-alias-state-error-primary)}.m2EMIa_instructions::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.m2EMIa_instructions::-webkit-scrollbar-track{margin:6px 0}.m2EMIa_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.m2EMIa_card:hover .m2EMIa_inspectButton,.m2EMIa_inspectButton:focus-visible{opacity:1}.m2EMIa_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.m2EMIa_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (prefers-reduced-motion:reduce){.m2EMIa_card[data-state=running] .m2EMIa_row:after{animation:none;display:none}.m2EMIa_iconIdle,.m2EMIa_chevronHover,.m2EMIa_inspectButton{transition:none}}";
		...
		var SkillRow_module_css_default = {
			"bodyWrap": "m2EMIa_bodyWrap",
			"card": "m2EMIa_card",
			"chevron": "m2EMIa_chevron",
			"chevronHover": "m2EMIa_chevronHover",
			"dsh-skill-row-sweep": "m2EMIa_dsh-skill-row-sweep",
			"errorSummary": "m2EMIa_errorSummary",
			"iconIdle": "m2EMIa_iconIdle",
			"inspectButton": "m2EMIa_inspectButton",
			"instructions": "m2EMIa_instructions",
			"instructionsCard": "m2EMIa_instructionsCard",
			"instructionsHeader": "m2EMIa_instructionsHeader",
			"leading": "m2EMIa_leading",
			"row": "m2EMIa_row",
			"separator": "m2EMIa_separator",
			"summary": "m2EMIa_summary",
			"title": "m2EMIa_title",
			"visuallyHidden": "m2EMIa_visuallyHidden"
		};
		//#endregion
