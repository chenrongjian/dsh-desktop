window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chenrongjian/WorkBuddy/DeepSeek/deepseek-harness/packages/client/ui-model-selection/src/client/ModelSelect.module.css.mjs
		const css = "._52FWVG_root{min-width:0;position:relative}._52FWVG_trigger{min-width:0;max-width:min(360px,45cqw);height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:24px;outline:none;align-items:center;gap:4px;padding:0 4px 0 8px;font-size:13px;font-weight:500;line-height:20px;display:flex}._52FWVG_trigger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}._52FWVG_trigger:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-border-l3)}._52FWVG_trigger:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}._52FWVG_triggerLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}._52FWVG_triggerEffort{color:var(--dsw-alias-label-caption);flex:none}._52FWVG_chevron{color:var(--dsw-alias-label-caption);flex:none;transition:transform .12s}._52FWVG_chevronOpen{transform:rotate(180deg)}._52FWVG_menu{z-index:20;border:1px solid var(--dsw-alias-border-inverted);background:var(--dsw-specific-menu);width:max-content;min-width:min(240px,100vw - 32px);max-width:min(420px,100vw - 32px);max-height:min(360px,100vh - 96px);box-shadow:var(--dsw-shadow-lv3);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:12px;flex-direction:column;padding:4px;display:flex;position:absolute;bottom:calc(100% + 8px);right:0;overflow:hidden}._52FWVG_status,._52FWVG_empty{color:var(--dsw-alias-label-tertiary);padding:10px;font-size:13px;line-height:20px}._52FWVG_error,._52FWVG_warning{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary);border-radius:8px;justify-content:space-between;align-items:flex-start;gap:8px;margin-bottom:4px;padding:7px 8px;font-size:12px;line-height:18px;display:flex}._52FWVG_warning{background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-state-warn-label)}._52FWVG_retry{color:inherit;font:inherit;cursor:pointer;background:0 0;border:none;flex:none;padding:0;font-weight:600}._52FWVG_groups{min-height:0;overflow-y:auto}._52FWVG_group+._52FWVG_group{margin-top:4px}._52FWVG_groupTitle{z-index:1;background:var(--dsw-specific-menu);color:var(--dsw-alias-label-tertiary);padding:5px 8px 3px;font-size:12px;font-weight:500;line-height:18px;position:sticky;top:0}._52FWVG_option{box-sizing:border-box;width:auto;min-width:100%;min-height:38px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:none;border-radius:10px;outline:none;align-items:center;gap:8px;padding:6px 8px;display:flex}._52FWVG_option:hover:not(:disabled),._52FWVG_option:focus-visible{background:var(--dsw-alias-interactive-bg-hover)}._52FWVG_selected{background:0 0}._52FWVG_option:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}._52FWVG_optionCopy{flex-direction:column;flex:1;min-width:0;display:flex}._52FWVG_modelName{color:inherit;text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:500;line-height:20px;overflow:hidden}._52FWVG_description{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}._52FWVG_check{color:var(--dsw-alias-label-primary);flex:0 0 18px;place-items:center;display:grid}._52FWVG_cell{box-sizing:border-box;width:auto;min-width:100%;height:40px;color:var(--dsw-alias-label-primary);cursor:pointer;text-align:left;background:0 0;border:none;border-radius:10px;align-items:center;gap:8px;padding:0 10px;font-size:14px;line-height:22px;display:flex}._52FWVG_cell:hover{background:var(--dsw-alias-interactive-bg-hover)}._52FWVG_cellLabel{white-space:nowrap;flex:none}._52FWVG_cellValue{text-overflow:ellipsis;white-space:nowrap;text-align:right;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;overflow:hidden}._52FWVG_cellChevron{color:var(--dsw-alias-label-tertiary);flex:none}";
		...
		var ModelSelect_module_css_default = {
			"cell": "_52FWVG_cell",
			"cellChevron": "_52FWVG_cellChevron",
			"cellLabel": "_52FWVG_cellLabel",
			"cellValue": "_52FWVG_cellValue",
			"check": "_52FWVG_check",
			"chevron": "_52FWVG_chevron",
			"chevronOpen": "_52FWVG_chevronOpen",
			"description": "_52FWVG_description",
			"empty": "_52FWVG_empty",
			"error": "_52FWVG_error",
			"group": "_52FWVG_group",
			"groupTitle": "_52FWVG_groupTitle",
			"groups": "_52FWVG_groups",
			"menu": "_52FWVG_menu",
			"modelName": "_52FWVG_modelName",
			"option": "_52FWVG_option",
			"optionCopy": "_52FWVG_optionCopy",
			"retry": "_52FWVG_retry",
			"root": "_52FWVG_root",
			"selected": "_52FWVG_selected",
			"status": "_52FWVG_status",
			"trigger": "_52FWVG_trigger",
			"triggerEffort": "_52FWVG_triggerEffort",
			"triggerLabel": "_52FWVG_triggerLabel",
			"warning": "_52FWVG_warning"
		};
		//#endregion
