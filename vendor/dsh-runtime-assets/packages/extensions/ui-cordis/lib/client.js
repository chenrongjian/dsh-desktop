window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chenrongjian/WorkBuddy/DeepSeek/deepseek-harness/packages/extensions/ui-cordis/src/client/CordisRunRow.module.css.mjs
		const css$2 = ".mUXyyW_card{flex-direction:column;gap:8px;display:flex}.mUXyyW_row{align-items:center;min-height:32px;display:flex}.mUXyyW_icon{color:var(--dsw-alias-state-business-primary);flex:none;margin-right:8px;display:inline-flex}.mUXyyW_title{color:var(--dsw-alias-state-business-primary);flex:none;font-size:14px;font-weight:500;line-height:24px}.mUXyyW_separator{background:var(--dsw-alias-state-business-primary);border-radius:50%;flex:none;width:2px;height:2px;margin:0 8px}.mUXyyW_summary,.mUXyyW_error{min-width:0;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;line-height:24px;overflow:hidden}.mUXyyW_error{color:var(--dsw-alias-state-error-primary)}.mUXyyW_status{color:var(--dsw-alias-label-caption);flex:none;margin-left:8px;font-size:12px;line-height:24px}.mUXyyW_card[data-cordis-status=awaiting-approval] .mUXyyW_status,.mUXyyW_card[data-cordis-status=client-pending] .mUXyyW_status{color:var(--dsw-alias-state-warn-label)}.mUXyyW_card[data-cordis-status=running] .mUXyyW_status{color:var(--dsw-alias-state-success-primary)}.mUXyyW_card[data-cordis-status=failed] .mUXyyW_status{color:var(--dsw-alias-state-error-primary)}.mUXyyW_inspect{width:24px;height:24px;color:var(--dsw-alias-label-tertiary);cursor:pointer;opacity:0;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;margin-left:4px;padding:0;display:inline-flex}.mUXyyW_card:hover .mUXyyW_inspect,.mUXyyW_inspect:focus-visible{opacity:1}.mUXyyW_inspect:hover{background:var(--dsw-alias-interactive-bg-hover)}.mUXyyW_message{background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-alias-label-tertiary);border-radius:8px;padding:8px 12px;font-size:12px;line-height:18px}.mUXyyW_business{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:12px;min-width:0;overflow:hidden}.mUXyyW_output{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block);color:var(--dsw-alias-label-secondary);font:var(--dsw-font-markdown-code-block-small);white-space:pre-wrap;overflow-wrap:anywhere;border-radius:8px;margin:0;padding:10px 12px;overflow:auto}.mUXyyW_business .mUXyyW_output{border:none;border-radius:0}";
		...
		var CordisRunRow_module_css_default = {
			"business": "mUXyyW_business",
			"card": "mUXyyW_card",
			"error": "mUXyyW_error",
			"icon": "mUXyyW_icon",
			"inspect": "mUXyyW_inspect",
			"message": "mUXyyW_message",
			"output": "mUXyyW_output",
			"row": "mUXyyW_row",
			"separator": "mUXyyW_separator",
			"status": "mUXyyW_status",
			"summary": "mUXyyW_summary",
			"title": "mUXyyW_title"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chenrongjian/WorkBuddy/DeepSeek/deepseek-harness/packages/extensions/ui-cordis/src/client/CordisDefineRow.module.css.mjs
		const css$1 = "._6i1wRG_card{flex-direction:column;display:flex}._6i1wRG_card ._6i1wRG_title,._6i1wRG_card ._6i1wRG_chevron{color:var(--dsw-alias-state-business-primary)}._6i1wRG_title{flex:none;font-size:14px;font-weight:500;line-height:24px}._6i1wRG_row{gap:0}._6i1wRG_separator{background:var(--dsw-alias-state-business-primary);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}._6i1wRG_name{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px;overflow:hidden}._6i1wRG_purpose{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;margin-left:8px;font-size:13px;line-height:24px;overflow:hidden}._6i1wRG_errorSummary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-state-error-primary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}._6i1wRG_requestError{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-state-error-primary);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}._6i1wRG_readout{flex:none;align-items:center;margin-left:8px;display:inline-flex}._6i1wRG_panelHint{color:var(--dsw-alias-label-caption);margin:4px 0 2px 4px;font-size:11px;line-height:16px}._6i1wRG_statusLabel{color:var(--dsw-alias-label-caption);font-size:12px;line-height:24px}._6i1wRG_approvalPrompt{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-secondary);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}._6i1wRG_notice{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-caption);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}._6i1wRG_switch{height:22px;padding:0 8px;font-size:12px}._6i1wRG_card[data-terminal] ._6i1wRG_title,._6i1wRG_card[data-terminal] ._6i1wRG_name,._6i1wRG_card[data-terminal] ._6i1wRG_purpose,._6i1wRG_card[data-terminal] ._6i1wRG_statusLabel{color:var(--dsw-alias-label-caption)}._6i1wRG_card[data-terminal] ._6i1wRG_separator{background:var(--dsw-alias-label-caption)}._6i1wRG_bodyWrap{flex-direction:column;display:flex}._6i1wRG_sourceCard{flex-direction:column;margin:4px 0 4px 4px;display:flex}._6i1wRG_sourceTabs{border-bottom:1px solid var(--dsw-alias-border-l2);height:32px;display:flex}._6i1wRG_sourceTab{color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xs-13);background:0 0;border:0;padding:0 10px;position:relative}._6i1wRG_sourceTab:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._6i1wRG_sourceTab:disabled{cursor:default;opacity:.4}._6i1wRG_sourceTabActive{color:var(--dsw-alias-state-business-primary)}._6i1wRG_sourceTabActive:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:1px 1px 0 0;height:2px;position:absolute;bottom:0;left:10px;right:10px}._6i1wRG_sourceTab:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}._6i1wRG_sourcePanel{max-height:260px;overflow:auto}._6i1wRG_sourceCode{margin:0}._6i1wRG_codeSection{flex-direction:column;max-height:260px;margin:4px 0 4px 4px;display:flex;overflow:auto}._6i1wRG_sectionLabel{color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;flex:none;padding:2px 0;font-size:11px;font-weight:500;line-height:16px}._6i1wRG_output{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-secondary);border-radius:8px;margin:0;padding:8px 10px}._6i1wRG_output[data-error]{color:var(--dsw-alias-state-error-primary)}._6i1wRG_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}._6i1wRG_card:hover ._6i1wRG_inspectButton,._6i1wRG_inspectButton:focus-visible{opacity:1}._6i1wRG_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}._6i1wRG_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (prefers-reduced-motion:reduce){._6i1wRG_inspectButton{transition:none}}";
		...
		var CordisDefineRow_module_css_default = {
			"approvalPrompt": "_6i1wRG_approvalPrompt",
			"bodyWrap": "_6i1wRG_bodyWrap",
			"card": "_6i1wRG_card",
			"chevron": "_6i1wRG_chevron",
			"codeSection": "_6i1wRG_codeSection",
			"errorSummary": "_6i1wRG_errorSummary",
			"inspectButton": "_6i1wRG_inspectButton",
			"name": "_6i1wRG_name",
			"notice": "_6i1wRG_notice",
			"output": "_6i1wRG_output",
			"panelHint": "_6i1wRG_panelHint",
			"purpose": "_6i1wRG_purpose",
			"readout": "_6i1wRG_readout",
			"requestError": "_6i1wRG_requestError",
			"row": "_6i1wRG_row",
			"sectionLabel": "_6i1wRG_sectionLabel",
			"separator": "_6i1wRG_separator",
			"sourceCard": "_6i1wRG_sourceCard",
			"sourceCode": "_6i1wRG_sourceCode",
			"sourcePanel": "_6i1wRG_sourcePanel",
			"sourceTab": "_6i1wRG_sourceTab",
			"sourceTabActive": "_6i1wRG_sourceTabActive",
			"sourceTabs": "_6i1wRG_sourceTabs",
			"statusLabel": "_6i1wRG_statusLabel",
			"switch": "_6i1wRG_switch",
			"title": "_6i1wRG_title",
			"visuallyHidden": "_6i1wRG_visuallyHidden"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/chenrongjian/WorkBuddy/DeepSeek/deepseek-harness/packages/extensions/ui-cordis/src/client/CordisPanel.module.css.mjs
		const css = ".l_yGLq_layer{flex:none;align-items:center;width:100%;height:42px;margin:8px 0 0;display:flex;position:relative}.l_yGLq_footerButtons{align-items:center;width:100%;display:flex}.l_yGLq_badge{width:calc(100% + 4px);height:42px;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border:none;border-radius:12px;align-items:center;gap:8px;margin:0 -2px;padding:0 10px 0 8px;font-family:inherit;font-size:14px;display:inline-flex;overflow:hidden}.l_yGLq_badge:hover,.l_yGLq_badge[data-active]{background:var(--dsw-alias-interactive-bg-hover)}.l_yGLq_badgeLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.l_yGLq_badgeCount{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;flex:none;margin-left:auto;font-size:12px;line-height:16px}.l_yGLq_layer.l_yGLq_rail{width:36px;height:36px;margin:0}.l_yGLq_rail .l_yGLq_badge{border-radius:50%;justify-content:center;gap:0;width:36px;height:36px;padding:0}.l_yGLq_rail .l_yGLq_footerButtons{flex-direction:column;gap:2px}.l_yGLq_panel{z-index:30;border:1px solid var(--dsw-alias-border-inverted);background:var(--dsw-specific-menu);width:420px;max-width:calc(100vw - 24px);max-height:60vh;box-shadow:var(--dsw-shadow-lv3);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:12px;flex-direction:column;display:flex;position:fixed;overflow:hidden}.l_yGLq_header{box-sizing:border-box;flex:none;justify-content:space-between;align-items:center;min-height:44px;padding:10px 12px;display:flex}.l_yGLq_body{flex:1;min-height:0;padding:0 12px 12px;overflow-y:auto}.l_yGLq_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:500;line-height:20px}.l_yGLq_note,.l_yGLq_readError{color:var(--dsw-alias-label-tertiary);margin:4px 0;font-size:12px;line-height:18px}.l_yGLq_readError{color:var(--dsw-alias-state-error-primary)}.l_yGLq_group{color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;margin:8px 0;font-size:11px;font-weight:500;line-height:16px}.l_yGLq_rows{flex-direction:column;gap:8px;margin:0;padding:0;list-style:none;display:flex}.l_yGLq_row{border:1px solid var(--dsw-alias-border-l2);border-radius:12px;flex-direction:column;gap:8px;padding:14px 12px 10px;display:flex}.l_yGLq_row[data-cordis-awaiting]{border-color:var(--dsw-alias-state-business-primary)}.l_yGLq_rowHead{align-items:center;gap:8px;display:flex}.l_yGLq_rowId{color:var(--dsw-alias-label-tertiary);font-family:var(--dsh-font-mono,monospace);flex:none;font-size:11px;line-height:20px}.l_yGLq_rowName{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.l_yGLq_rowStatus{background:var(--dsw-alias-button-ghost-active-fill);height:20px;color:var(--dsw-alias-label-caption);border-radius:10px;flex:none;align-items:center;padding:0 6px;font-size:11px;line-height:20px;display:inline-flex}.l_yGLq_row[data-cordis-status=idle] .l_yGLq_rowStatus{background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-alias-label-caption)}.l_yGLq_row[data-cordis-status=awaiting-approval] .l_yGLq_rowStatus,.l_yGLq_row[data-cordis-status=client-pending] .l_yGLq_rowStatus{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-label)}.l_yGLq_row[data-cordis-status=failed] .l_yGLq_rowStatus{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.l_yGLq_row[data-cordis-status=running] .l_yGLq_rowStatus{background:var(--dsw-alias-state-success-tertiary);color:var(--dsw-alias-state-success-primary)}.l_yGLq_rowDetail{align-items:center;gap:8px;min-height:28px;display:flex}.l_yGLq_versionPicker{color:var(--dsw-alias-label-caption);align-items:center;gap:8px;font-size:11px;line-height:18px;display:flex}.l_yGLq_versionPicker select{border:1px solid var(--dsw-alias-border-l2);min-width:0;height:26px;color:var(--dsw-alias-label-secondary);font:inherit;background:0 0;border-radius:7px;flex:1;padding:0 8px}.l_yGLq_rowPurpose{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:12px;line-height:18px;overflow:hidden}.l_yGLq_rowError{color:var(--dsw-alias-state-error-primary);font-size:12px;line-height:18px}.l_yGLq_rowActions{flex:none;align-items:center;gap:10px;display:flex}.l_yGLq_transition{min-width:0;color:var(--dsw-alias-label-caption);align-items:center;gap:8px;font-size:11px;line-height:18px;display:flex}.l_yGLq_transitionActions{gap:6px;margin-left:auto;display:flex}.l_yGLq_transitionActions button{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border-radius:999px;padding:2px 8px}.l_yGLq_transitionActions button:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.l_yGLq_transitionActions button:disabled{opacity:.4;cursor:default}.l_yGLq_activeVersion{color:var(--dsw-alias-label-caption);font-size:11px;line-height:16px}.l_yGLq_actionButton{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;padding:0;display:inline-flex}.l_yGLq_actionButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.l_yGLq_actionButton:disabled{opacity:.4;cursor:default}.l_yGLq_doubleCheck{width:17px;height:14px;display:inline-block;position:relative}.l_yGLq_doubleCheck svg{position:absolute;top:1px}.l_yGLq_doubleCheck svg:first-child{opacity:.7;left:0}.l_yGLq_doubleCheck svg:last-child{left:5px}";
		...
		var CordisPanel_module_css_default = {
			"actionButton": "l_yGLq_actionButton",
			"activeVersion": "l_yGLq_activeVersion",
			"badge": "l_yGLq_badge",
			"badgeCount": "l_yGLq_badgeCount",
			"badgeLabel": "l_yGLq_badgeLabel",
			"body": "l_yGLq_body",
			"doubleCheck": "l_yGLq_doubleCheck",
			"footerButtons": "l_yGLq_footerButtons",
			"group": "l_yGLq_group",
			"header": "l_yGLq_header",
			"layer": "l_yGLq_layer",
			"note": "l_yGLq_note",
			"panel": "l_yGLq_panel",
			"rail": "l_yGLq_rail",
			"readError": "l_yGLq_readError",
			"row": "l_yGLq_row",
			"rowActions": "l_yGLq_rowActions",
			"rowDetail": "l_yGLq_rowDetail",
			"rowError": "l_yGLq_rowError",
			"rowHead": "l_yGLq_rowHead",
			"rowId": "l_yGLq_rowId",
			"rowName": "l_yGLq_rowName",
			"rowPurpose": "l_yGLq_rowPurpose",
			"rowStatus": "l_yGLq_rowStatus",
			"rows": "l_yGLq_rows",
			"title": "l_yGLq_title",
			"transition": "l_yGLq_transition",
			"transitionActions": "l_yGLq_transitionActions",
			"versionPicker": "l_yGLq_versionPicker"
		};
		//#endregion
